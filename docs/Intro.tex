...
<pre class="Agda">
<a id="2812" class="Symbol">{-#</a> <a id="2816" class="Keyword">OPTIONS</a> <a id="2824" class="Pragma">--without-K</a> <a id="2836" class="Symbol">#-}</a>
</pre>
...
<pre class="Agda">
<a id="3166" class="Symbol">{-#</a> <a id="3170" class="Keyword">OPTIONS</a> <a id="3178" class="Pragma">--exact-split</a> <a id="3192" class="Symbol">#-}</a>
</pre>

<pre class="Agda">
<a id="3221" class="Keyword">open</a> <a id="3226" class="Keyword">import</a> <a id="3233" href="Agda.Primitive.html" class="Module">Agda.Primitive</a>
  <a id="3250" class="Keyword">using</a> <a id="3256" class="Symbol">(</a> <a id="3258" href="Agda.Primitive.html#408" class="Postulate">Level</a> <a id="3264" class="Symbol">;</a> <a id="3266" href="Agda.Primitive.html#627" class="Primitive">lsuc</a><a id="3270" class="Symbol">;</a> <a id="3272" href="Agda.Primitive.html#611" class="Primitive">lzero</a><a id="3277" class="Symbol">;</a> <a id="3279" href="Agda.Primitive.html#657" class="Primitive Operator">_⊔_</a> <a id="3283" class="Symbol">)</a> <a id="3285" class="Keyword">public</a>
</pre>
...
<pre class="Agda">
<a id="Type"></a><a id="3448" href="Intro.html#3448" class="Function">Type</a>
  <a id="3455" class="Symbol">:</a> <a id="3457" class="Symbol">(</a><a id="3458" href="Intro.html#3458" class="Bound">ℓ</a> <a id="3460" class="Symbol">:</a> <a id="3462" href="Agda.Primitive.html#408" class="Postulate">Level</a><a id="3467" class="Symbol">)</a>
  <a id="3471" class="Symbol">→</a> <a id="3473" class="PrimitiveType">Set</a> <a id="3477" class="Symbol">(</a><a id="3478" href="Agda.Primitive.html#627" class="Primitive">lsuc</a> <a id="3483" href="Intro.html#3458" class="Bound">ℓ</a><a id="3484" class="Symbol">)</a>

<a id="3487" href="Intro.html#3448" class="Function">Type</a> <a id="3492" href="Intro.html#3492" class="Bound">ℓ</a> <a id="3494" class="Symbol">=</a> <a id="3496" class="PrimitiveType">Set</a> <a id="3500" href="Intro.html#3492" class="Bound">ℓ</a>
</pre>

<pre class="Agda">
<a id="Type₀"></a><a id="3527" href="Intro.html#3527" class="Function">Type₀</a>
  <a id="3535" class="Symbol">:</a> <a id="3537" href="Intro.html#3448" class="Function">Type</a> <a id="3542" class="Symbol">(</a><a id="3543" href="Agda.Primitive.html#627" class="Primitive">lsuc</a> <a id="3548" href="Agda.Primitive.html#611" class="Primitive">lzero</a><a id="3553" class="Symbol">)</a>

<a id="3556" href="Intro.html#3527" class="Function">Type₀</a> <a id="3562" class="Symbol">=</a> <a id="3564" href="Intro.html#3448" class="Function">Type</a> <a id="3569" href="Agda.Primitive.html#611" class="Primitive">lzero</a>
</pre>

<pre class="Agda">
<a id="Type₁"></a><a id="3600" href="Intro.html#3600" class="Function">Type₁</a>
  <a id="3608" class="Symbol">:</a> <a id="3610" href="Intro.html#3448" class="Function">Type</a> <a id="3615" class="Symbol">(</a><a id="3616" href="Agda.Primitive.html#627" class="Primitive">lsuc</a> <a id="3621" class="Symbol">(</a><a id="3622" href="Agda.Primitive.html#627" class="Primitive">lsuc</a> <a id="3627" href="Agda.Primitive.html#611" class="Primitive">lzero</a><a id="3632" class="Symbol">))</a>

<a id="3636" href="Intro.html#3600" class="Function">Type₁</a> <a id="3642" class="Symbol">=</a> <a id="3644" href="Intro.html#3448" class="Function">Type</a> <a id="3649" class="Symbol">(</a><a id="3650" href="Agda.Primitive.html#627" class="Primitive">lsuc</a> <a id="3655" href="Agda.Primitive.html#611" class="Primitive">lzero</a><a id="3660" class="Symbol">)</a>
</pre>

The following type is to lift a type to a higher universe.

<pre class="Agda">
<a id="3747" class="Keyword">record</a>
  <a id="↑"></a><a id="3756" href="Intro.html#3756" class="Record">↑</a> <a id="3758" class="Symbol">{</a><a id="3759" href="Intro.html#3759" class="Bound">a</a> <a id="3761" class="Symbol">:</a> <a id="3763" href="Agda.Primitive.html#408" class="Postulate">Level</a><a id="3768" class="Symbol">}</a> <a id="3770" href="Intro.html#3770" class="Bound">ℓ</a> <a id="3772" class="Symbol">(</a><a id="3773" href="Intro.html#3773" class="Bound">A</a> <a id="3775" class="Symbol">:</a> <a id="3777" href="Intro.html#3448" class="Function">Type</a> <a id="3782" href="Intro.html#3759" class="Bound">a</a><a id="3783" class="Symbol">)</a>
    <a id="3789" class="Symbol">:</a> <a id="3791" href="Intro.html#3448" class="Function">Type</a> <a id="3796" class="Symbol">(</a><a id="3797" href="Intro.html#3759" class="Bound">a</a> <a id="3799" href="Agda.Primitive.html#657" class="Primitive Operator">⊔</a> <a id="3801" href="Intro.html#3770" class="Bound">ℓ</a><a id="3802" class="Symbol">)</a>
  <a id="3806" class="Keyword">where</a>
  <a id="3814" class="Keyword">constructor</a> <a id="↑.Lift"></a><a id="3826" href="Intro.html#3826" class="InductiveConstructor">Lift</a>
  <a id="3833" class="Keyword">field</a>
    <a id="↑.lower"></a><a id="3843" href="Intro.html#3843" class="Field">lower</a> <a id="3849" class="Symbol">:</a> <a id="3851" href="Intro.html#3773" class="Bound">A</a>

<a id="3854" class="Keyword">open</a> <a id="3859" href="Intro.html#3756" class="Module">↑</a> <a id="3861" class="Keyword">public</a>
</pre>
