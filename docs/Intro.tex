...
<pre class="Agda">
<a id="2450" class="Symbol">{-#</a> <a id="2454" class="Keyword">OPTIONS</a> <a id="2462" class="Pragma">--without-K</a> <a id="2474" class="Symbol">#-}</a>
</pre>
...
<pre class="Agda">
<a id="2704" class="Keyword">open</a> <a id="2709" class="Keyword">import</a> <a id="2716" href="Agda.Primitive.html" class="Module">Agda.Primitive</a>
  <a id="2733" class="Keyword">using</a> <a id="2739" class="Symbol">(</a> <a id="2741" href="Agda.Primitive.html#408" class="Postulate">Level</a> <a id="2747" class="Symbol">;</a> <a id="2749" href="Agda.Primitive.html#627" class="Primitive">lsuc</a><a id="2753" class="Symbol">;</a> <a id="2755" href="Agda.Primitive.html#611" class="Primitive">lzero</a><a id="2760" class="Symbol">;</a> <a id="2762" href="Agda.Primitive.html#657" class="Primitive Operator">_⊔_</a> <a id="2766" class="Symbol">)</a> <a id="2768" class="Keyword">public</a>
</pre>
...
<pre class="Agda">
<a id="Type"></a><a id="2931" href="Intro.html#2931" class="Function">Type</a>
  <a id="2938" class="Symbol">:</a> <a id="2940" class="Symbol">(</a><a id="2941" href="Intro.html#2941" class="Bound">ℓ</a> <a id="2943" class="Symbol">:</a> <a id="2945" href="Agda.Primitive.html#408" class="Postulate">Level</a><a id="2950" class="Symbol">)</a>
  <a id="2954" class="Symbol">→</a> <a id="2956" class="PrimitiveType">Set</a> <a id="2960" class="Symbol">(</a><a id="2961" href="Agda.Primitive.html#627" class="Primitive">lsuc</a> <a id="2966" href="Intro.html#2941" class="Bound">ℓ</a><a id="2967" class="Symbol">)</a>

<a id="2970" href="Intro.html#2931" class="Function">Type</a> <a id="2975" href="Intro.html#2975" class="Bound">ℓ</a> <a id="2977" class="Symbol">=</a> <a id="2979" class="PrimitiveType">Set</a> <a id="2983" href="Intro.html#2975" class="Bound">ℓ</a>
</pre>

<pre class="Agda">
<a id="Type₀"></a><a id="3010" href="Intro.html#3010" class="Function">Type₀</a>
  <a id="3018" class="Symbol">:</a> <a id="3020" href="Intro.html#2931" class="Function">Type</a> <a id="3025" class="Symbol">(</a><a id="3026" href="Agda.Primitive.html#627" class="Primitive">lsuc</a> <a id="3031" href="Agda.Primitive.html#611" class="Primitive">lzero</a><a id="3036" class="Symbol">)</a>

<a id="3039" href="Intro.html#3010" class="Function">Type₀</a> <a id="3045" class="Symbol">=</a> <a id="3047" href="Intro.html#2931" class="Function">Type</a> <a id="3052" href="Agda.Primitive.html#611" class="Primitive">lzero</a>
</pre>

<pre class="Agda">
<a id="Type₁"></a><a id="3083" href="Intro.html#3083" class="Function">Type₁</a>
  <a id="3091" class="Symbol">:</a> <a id="3093" href="Intro.html#2931" class="Function">Type</a> <a id="3098" class="Symbol">(</a><a id="3099" href="Agda.Primitive.html#627" class="Primitive">lsuc</a> <a id="3104" class="Symbol">(</a><a id="3105" href="Agda.Primitive.html#627" class="Primitive">lsuc</a> <a id="3110" href="Agda.Primitive.html#611" class="Primitive">lzero</a><a id="3115" class="Symbol">))</a>

<a id="3119" href="Intro.html#3083" class="Function">Type₁</a> <a id="3125" class="Symbol">=</a> <a id="3127" href="Intro.html#2931" class="Function">Type</a> <a id="3132" class="Symbol">(</a><a id="3133" href="Agda.Primitive.html#627" class="Primitive">lsuc</a> <a id="3138" href="Agda.Primitive.html#611" class="Primitive">lzero</a><a id="3143" class="Symbol">)</a>
</pre>

The following type is to lift a type to a higher universe.

<pre class="Agda">
<a id="3230" class="Keyword">record</a>
  <a id="↑"></a><a id="3239" href="Intro.html#3239" class="Record">↑</a> <a id="3241" class="Symbol">{</a><a id="3242" href="Intro.html#3242" class="Bound">a</a> <a id="3244" class="Symbol">:</a> <a id="3246" href="Agda.Primitive.html#408" class="Postulate">Level</a><a id="3251" class="Symbol">}</a> <a id="3253" href="Intro.html#3253" class="Bound">ℓ</a> <a id="3255" class="Symbol">(</a><a id="3256" href="Intro.html#3256" class="Bound">A</a> <a id="3258" class="Symbol">:</a> <a id="3260" href="Intro.html#2931" class="Function">Type</a> <a id="3265" href="Intro.html#3242" class="Bound">a</a><a id="3266" class="Symbol">)</a>
    <a id="3272" class="Symbol">:</a> <a id="3274" href="Intro.html#2931" class="Function">Type</a> <a id="3279" class="Symbol">(</a><a id="3280" href="Intro.html#3242" class="Bound">a</a> <a id="3282" href="Agda.Primitive.html#657" class="Primitive Operator">⊔</a> <a id="3284" href="Intro.html#3253" class="Bound">ℓ</a><a id="3285" class="Symbol">)</a>
  <a id="3289" class="Keyword">where</a>
  <a id="3297" class="Keyword">constructor</a> <a id="↑.Lift"></a><a id="3309" href="Intro.html#3309" class="InductiveConstructor">Lift</a>
  <a id="3316" class="Keyword">field</a>
    <a id="↑.lower"></a><a id="3326" href="Intro.html#3326" class="Field">lower</a> <a id="3332" class="Symbol">:</a> <a id="3334" href="Intro.html#3256" class="Bound">A</a>

<a id="3337" class="Keyword">open</a> <a id="3342" href="Intro.html#3239" class="Module">↑</a> <a id="3344" class="Keyword">public</a>
</pre>
