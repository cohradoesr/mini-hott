...
<div class="sidebar" id="sidebar">
  ...
  <li class="sidebar-toc-item"><a href="#" class="sidebar-nav-item">Introduction</a></li>
  <li class="sidebar-toc-item"><a href="#stickyTitle" class="sidebar-nav-item"><svg height="22" class="octicon octicon-bookmark" viewBox="0 0 10 16" version="1.1" width="13" aria-hidden="true"><path fill-rule="evenodd" d="M9 0H1C.27 0 0 .27 0 1v15l5-3.09L10 16V1c0-.73-.27-1-1-1zm-.78 4.25L6.36 5.61l.72 2.16c.06.22-.02.28-.2.17L5 6.6 3.12 7.94c-.19.11-.25.05-.2-.17l.72-2.16-1.86-1.36c-.17-.16-.14-.23.09-.23l2.3-.03.7-2.16h.25l.7 2.16 2.3.03c.23 0 .27.08.09.23h.01z"></path></svg> Introduction <small style="float:right">(Intro.tex)</small>
</a>
    <ul>
...
<pre class="Agda">
<a id="2978" class="Symbol">{-#</a> <a id="2982" class="Keyword">OPTIONS</a> <a id="2990" class="Pragma">--without-K</a> <a id="3002" class="Symbol">#-}</a>
</pre>
...
<pre class="Agda">
<a id="3330" class="Symbol">{-#</a> <a id="3334" class="Keyword">OPTIONS</a> <a id="3342" class="Pragma">--exact-split</a> <a id="3356" class="Symbol">#-}</a>
</pre>

<pre class="Agda">
<a id="3385" class="Keyword">open</a> <a id="3390" class="Keyword">import</a> <a id="3397" href="Agda.Primitive.html" class="Module">Agda.Primitive</a>
  <a id="3414" class="Keyword">using</a> <a id="3420" class="Symbol">(</a> <a id="3422" href="Agda.Primitive.html#408" class="Postulate">Level</a> <a id="3428" class="Symbol">;</a> <a id="3430" href="Agda.Primitive.html#627" class="Primitive">lsuc</a><a id="3434" class="Symbol">;</a> <a id="3436" href="Agda.Primitive.html#611" class="Primitive">lzero</a><a id="3441" class="Symbol">;</a> <a id="3443" href="Agda.Primitive.html#657" class="Primitive Operator">_⊔_</a> <a id="3447" class="Symbol">)</a> <a id="3449" class="Keyword">public</a>
</pre>
...
<pre class="Agda">
<a id="Type"></a><a id="3612" href="Intro.html#3612" class="Function">Type</a>
  <a id="3619" class="Symbol">:</a> <a id="3621" class="Symbol">(</a><a id="3622" href="Intro.html#3622" class="Bound">ℓ</a> <a id="3624" class="Symbol">:</a> <a id="3626" href="Agda.Primitive.html#408" class="Postulate">Level</a><a id="3631" class="Symbol">)</a>
  <a id="3635" class="Symbol">→</a> <a id="3637" class="PrimitiveType">Set</a> <a id="3641" class="Symbol">(</a><a id="3642" href="Agda.Primitive.html#627" class="Primitive">lsuc</a> <a id="3647" href="Intro.html#3622" class="Bound">ℓ</a><a id="3648" class="Symbol">)</a>

<a id="3651" href="Intro.html#3612" class="Function">Type</a> <a id="3656" href="Intro.html#3656" class="Bound">ℓ</a> <a id="3658" class="Symbol">=</a> <a id="3660" class="PrimitiveType">Set</a> <a id="3664" href="Intro.html#3656" class="Bound">ℓ</a>
</pre>

<pre class="Agda">
<a id="Type₀"></a><a id="3691" href="Intro.html#3691" class="Function">Type₀</a>
  <a id="3699" class="Symbol">:</a> <a id="3701" href="Intro.html#3612" class="Function">Type</a> <a id="3706" class="Symbol">(</a><a id="3707" href="Agda.Primitive.html#627" class="Primitive">lsuc</a> <a id="3712" href="Agda.Primitive.html#611" class="Primitive">lzero</a><a id="3717" class="Symbol">)</a>

<a id="3720" href="Intro.html#3691" class="Function">Type₀</a> <a id="3726" class="Symbol">=</a> <a id="3728" href="Intro.html#3612" class="Function">Type</a> <a id="3733" href="Agda.Primitive.html#611" class="Primitive">lzero</a>
</pre>

<pre class="Agda">
<a id="Type₁"></a><a id="3764" href="Intro.html#3764" class="Function">Type₁</a>
  <a id="3772" class="Symbol">:</a> <a id="3774" href="Intro.html#3612" class="Function">Type</a> <a id="3779" class="Symbol">(</a><a id="3780" href="Agda.Primitive.html#627" class="Primitive">lsuc</a> <a id="3785" class="Symbol">(</a><a id="3786" href="Agda.Primitive.html#627" class="Primitive">lsuc</a> <a id="3791" href="Agda.Primitive.html#611" class="Primitive">lzero</a><a id="3796" class="Symbol">))</a>

<a id="3800" href="Intro.html#3764" class="Function">Type₁</a> <a id="3806" class="Symbol">=</a> <a id="3808" href="Intro.html#3612" class="Function">Type</a> <a id="3813" class="Symbol">(</a><a id="3814" href="Agda.Primitive.html#627" class="Primitive">lsuc</a> <a id="3819" href="Agda.Primitive.html#611" class="Primitive">lzero</a><a id="3824" class="Symbol">)</a>
</pre>

The following type is to lift a type to a higher universe.

<pre class="Agda">
<a id="3911" class="Keyword">record</a>
  <a id="↑"></a><a id="3920" href="Intro.html#3920" class="Record">↑</a> <a id="3922" class="Symbol">{</a><a id="3923" href="Intro.html#3923" class="Bound">a</a> <a id="3925" class="Symbol">:</a> <a id="3927" href="Agda.Primitive.html#408" class="Postulate">Level</a><a id="3932" class="Symbol">}</a> <a id="3934" href="Intro.html#3934" class="Bound">ℓ</a> <a id="3936" class="Symbol">(</a><a id="3937" href="Intro.html#3937" class="Bound">A</a> <a id="3939" class="Symbol">:</a> <a id="3941" href="Intro.html#3612" class="Function">Type</a> <a id="3946" href="Intro.html#3923" class="Bound">a</a><a id="3947" class="Symbol">)</a>
    <a id="3953" class="Symbol">:</a> <a id="3955" href="Intro.html#3612" class="Function">Type</a> <a id="3960" class="Symbol">(</a><a id="3961" href="Intro.html#3923" class="Bound">a</a> <a id="3963" href="Agda.Primitive.html#657" class="Primitive Operator">⊔</a> <a id="3965" href="Intro.html#3934" class="Bound">ℓ</a><a id="3966" class="Symbol">)</a>
  <a id="3970" class="Keyword">where</a>
  <a id="3978" class="Keyword">constructor</a> <a id="↑.Lift"></a><a id="3990" href="Intro.html#3990" class="InductiveConstructor">Lift</a>
  <a id="3997" class="Keyword">field</a>
    <a id="↑.lower"></a><a id="4007" href="Intro.html#4007" class="Field">lower</a> <a id="4013" class="Symbol">:</a> <a id="4015" href="Intro.html#3937" class="Bound">A</a>

<a id="4018" class="Keyword">open</a> <a id="4023" href="Intro.html#3920" class="Module">↑</a> <a id="4025" class="Keyword">public</a>
</pre>
...
A type and lifted types of it are *equivalent* types.
  ...
  <div id="github-links">
    <div class="view-source">
      ...
      <a href="https://github.com/jonaprieto/mini-hott/blob/master/src/Intro.tex" target="_blank"><svg height="12" class="octicon octicon-mark-github right left" viewBox="0 0 16 16" version="1.1" width="12" aria-hidden="true"><path fill-rule="evenodd" d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27 2-.27.68 0 1.36.09 2 .27 1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.013 8.013 0 0 0 16 8c0-4.42-3.58-8-8-8z"/></svg> Github</a>
