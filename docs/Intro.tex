...
<pre class="Agda">
<a id="2986" class="Symbol">{-#</a> <a id="2990" class="Keyword">OPTIONS</a> <a id="2998" class="Pragma">--without-K</a> <a id="3010" class="Symbol">#-}</a>
</pre>
...
<pre class="Agda">
<a id="3338" class="Symbol">{-#</a> <a id="3342" class="Keyword">OPTIONS</a> <a id="3350" class="Pragma">--exact-split</a> <a id="3364" class="Symbol">#-}</a>
</pre>

<pre class="Agda">
<a id="3393" class="Keyword">open</a> <a id="3398" class="Keyword">import</a> <a id="3405" href="Agda.Primitive.html" class="Module">Agda.Primitive</a>
  <a id="3422" class="Keyword">using</a> <a id="3428" class="Symbol">(</a> <a id="3430" href="Agda.Primitive.html#408" class="Postulate">Level</a> <a id="3436" class="Symbol">;</a> <a id="3438" href="Agda.Primitive.html#627" class="Primitive">lsuc</a><a id="3442" class="Symbol">;</a> <a id="3444" href="Agda.Primitive.html#611" class="Primitive">lzero</a><a id="3449" class="Symbol">;</a> <a id="3451" href="Agda.Primitive.html#657" class="Primitive Operator">_⊔_</a> <a id="3455" class="Symbol">)</a> <a id="3457" class="Keyword">public</a>
</pre>
...
<pre class="Agda">
<a id="Type"></a><a id="3620" href="Intro.html#3620" class="Function">Type</a>
  <a id="3627" class="Symbol">:</a> <a id="3629" class="Symbol">(</a><a id="3630" href="Intro.html#3630" class="Bound">ℓ</a> <a id="3632" class="Symbol">:</a> <a id="3634" href="Agda.Primitive.html#408" class="Postulate">Level</a><a id="3639" class="Symbol">)</a>
  <a id="3643" class="Symbol">→</a> <a id="3645" class="PrimitiveType">Set</a> <a id="3649" class="Symbol">(</a><a id="3650" href="Agda.Primitive.html#627" class="Primitive">lsuc</a> <a id="3655" href="Intro.html#3630" class="Bound">ℓ</a><a id="3656" class="Symbol">)</a>

<a id="3659" href="Intro.html#3620" class="Function">Type</a> <a id="3664" href="Intro.html#3664" class="Bound">ℓ</a> <a id="3666" class="Symbol">=</a> <a id="3668" class="PrimitiveType">Set</a> <a id="3672" href="Intro.html#3664" class="Bound">ℓ</a>
</pre>

<pre class="Agda">
<a id="Type₀"></a><a id="3699" href="Intro.html#3699" class="Function">Type₀</a>
  <a id="3707" class="Symbol">:</a> <a id="3709" href="Intro.html#3620" class="Function">Type</a> <a id="3714" class="Symbol">(</a><a id="3715" href="Agda.Primitive.html#627" class="Primitive">lsuc</a> <a id="3720" href="Agda.Primitive.html#611" class="Primitive">lzero</a><a id="3725" class="Symbol">)</a>

<a id="3728" href="Intro.html#3699" class="Function">Type₀</a> <a id="3734" class="Symbol">=</a> <a id="3736" href="Intro.html#3620" class="Function">Type</a> <a id="3741" href="Agda.Primitive.html#611" class="Primitive">lzero</a>
</pre>

<pre class="Agda">
<a id="Type₁"></a><a id="3772" href="Intro.html#3772" class="Function">Type₁</a>
  <a id="3780" class="Symbol">:</a> <a id="3782" href="Intro.html#3620" class="Function">Type</a> <a id="3787" class="Symbol">(</a><a id="3788" href="Agda.Primitive.html#627" class="Primitive">lsuc</a> <a id="3793" class="Symbol">(</a><a id="3794" href="Agda.Primitive.html#627" class="Primitive">lsuc</a> <a id="3799" href="Agda.Primitive.html#611" class="Primitive">lzero</a><a id="3804" class="Symbol">))</a>

<a id="3808" href="Intro.html#3772" class="Function">Type₁</a> <a id="3814" class="Symbol">=</a> <a id="3816" href="Intro.html#3620" class="Function">Type</a> <a id="3821" class="Symbol">(</a><a id="3822" href="Agda.Primitive.html#627" class="Primitive">lsuc</a> <a id="3827" href="Agda.Primitive.html#611" class="Primitive">lzero</a><a id="3832" class="Symbol">)</a>
</pre>

The following type is to lift a type to a higher universe.

<pre class="Agda">
<a id="3919" class="Keyword">record</a>
  <a id="↑"></a><a id="3928" href="Intro.html#3928" class="Record">↑</a> <a id="3930" class="Symbol">{</a><a id="3931" href="Intro.html#3931" class="Bound">a</a> <a id="3933" class="Symbol">:</a> <a id="3935" href="Agda.Primitive.html#408" class="Postulate">Level</a><a id="3940" class="Symbol">}</a> <a id="3942" href="Intro.html#3942" class="Bound">ℓ</a> <a id="3944" class="Symbol">(</a><a id="3945" href="Intro.html#3945" class="Bound">A</a> <a id="3947" class="Symbol">:</a> <a id="3949" href="Intro.html#3620" class="Function">Type</a> <a id="3954" href="Intro.html#3931" class="Bound">a</a><a id="3955" class="Symbol">)</a>
    <a id="3961" class="Symbol">:</a> <a id="3963" href="Intro.html#3620" class="Function">Type</a> <a id="3968" class="Symbol">(</a><a id="3969" href="Intro.html#3931" class="Bound">a</a> <a id="3971" href="Agda.Primitive.html#657" class="Primitive Operator">⊔</a> <a id="3973" href="Intro.html#3942" class="Bound">ℓ</a><a id="3974" class="Symbol">)</a>
  <a id="3978" class="Keyword">where</a>
  <a id="3986" class="Keyword">constructor</a> <a id="↑.Lift"></a><a id="3998" href="Intro.html#3998" class="InductiveConstructor">Lift</a>
  <a id="4005" class="Keyword">field</a>
    <a id="↑.lower"></a><a id="4015" href="Intro.html#4015" class="Field">lower</a> <a id="4021" class="Symbol">:</a> <a id="4023" href="Intro.html#3945" class="Bound">A</a>

<a id="4026" class="Keyword">open</a> <a id="4031" href="Intro.html#3928" class="Module">↑</a> <a id="4033" class="Keyword">public</a>
</pre>
