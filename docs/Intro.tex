...
<div class="post">
  ...
  ![path](/mini-hott/assets/png-images/mini-hott.jpeg){: width="150px" align="right" style="padding:5px"}
...
<pre class="Agda">
<a id="2330" class="Symbol">{-#</a> <a id="2334" class="Keyword">OPTIONS</a> <a id="2342" class="Pragma">--without-K</a> <a id="2354" class="Symbol">#-}</a>
</pre>
...
<pre class="Agda">
<a id="2584" class="Keyword">open</a> <a id="2589" class="Keyword">import</a> <a id="2596" href="Agda.Primitive.html" class="Module">Agda.Primitive</a>
  <a id="2613" class="Keyword">using</a> <a id="2619" class="Symbol">(</a> <a id="2621" href="Agda.Primitive.html#408" class="Postulate">Level</a> <a id="2627" class="Symbol">;</a> <a id="2629" href="Agda.Primitive.html#627" class="Primitive">lsuc</a><a id="2633" class="Symbol">;</a> <a id="2635" href="Agda.Primitive.html#611" class="Primitive">lzero</a><a id="2640" class="Symbol">;</a> <a id="2642" href="Agda.Primitive.html#657" class="Primitive Operator">_⊔_</a> <a id="2646" class="Symbol">)</a> <a id="2648" class="Keyword">public</a>
</pre>
...
<pre class="Agda">
<a id="Type"></a><a id="2811" href="Intro.html#2811" class="Function">Type</a>
  <a id="2818" class="Symbol">:</a> <a id="2820" class="Symbol">(</a><a id="2821" href="Intro.html#2821" class="Bound">ℓ</a> <a id="2823" class="Symbol">:</a> <a id="2825" href="Agda.Primitive.html#408" class="Postulate">Level</a><a id="2830" class="Symbol">)</a>
  <a id="2834" class="Symbol">→</a> <a id="2836" class="PrimitiveType">Set</a> <a id="2840" class="Symbol">(</a><a id="2841" href="Agda.Primitive.html#627" class="Primitive">lsuc</a> <a id="2846" href="Intro.html#2821" class="Bound">ℓ</a><a id="2847" class="Symbol">)</a>

<a id="2850" href="Intro.html#2811" class="Function">Type</a> <a id="2855" href="Intro.html#2855" class="Bound">ℓ</a> <a id="2857" class="Symbol">=</a> <a id="2859" class="PrimitiveType">Set</a> <a id="2863" href="Intro.html#2855" class="Bound">ℓ</a>
</pre>

<pre class="Agda">
<a id="Type₀"></a><a id="2890" href="Intro.html#2890" class="Function">Type₀</a>
  <a id="2898" class="Symbol">:</a> <a id="2900" href="Intro.html#2811" class="Function">Type</a> <a id="2905" class="Symbol">(</a><a id="2906" href="Agda.Primitive.html#627" class="Primitive">lsuc</a> <a id="2911" href="Agda.Primitive.html#611" class="Primitive">lzero</a><a id="2916" class="Symbol">)</a>

<a id="2919" href="Intro.html#2890" class="Function">Type₀</a> <a id="2925" class="Symbol">=</a> <a id="2927" href="Intro.html#2811" class="Function">Type</a> <a id="2932" href="Agda.Primitive.html#611" class="Primitive">lzero</a>
</pre>

<pre class="Agda">
<a id="Type₁"></a><a id="2963" href="Intro.html#2963" class="Function">Type₁</a>
  <a id="2971" class="Symbol">:</a> <a id="2973" href="Intro.html#2811" class="Function">Type</a> <a id="2978" class="Symbol">(</a><a id="2979" href="Agda.Primitive.html#627" class="Primitive">lsuc</a> <a id="2984" class="Symbol">(</a><a id="2985" href="Agda.Primitive.html#627" class="Primitive">lsuc</a> <a id="2990" href="Agda.Primitive.html#611" class="Primitive">lzero</a><a id="2995" class="Symbol">))</a>

<a id="2999" href="Intro.html#2963" class="Function">Type₁</a> <a id="3005" class="Symbol">=</a> <a id="3007" href="Intro.html#2811" class="Function">Type</a> <a id="3012" class="Symbol">(</a><a id="3013" href="Agda.Primitive.html#627" class="Primitive">lsuc</a> <a id="3018" href="Agda.Primitive.html#611" class="Primitive">lzero</a><a id="3023" class="Symbol">)</a>
</pre>

The following type is to lift a type to a higher universe.

<pre class="Agda">
<a id="3110" class="Keyword">record</a>
  <a id="↑"></a><a id="3119" href="Intro.html#3119" class="Record">↑</a> <a id="3121" class="Symbol">{</a><a id="3122" href="Intro.html#3122" class="Bound">a</a> <a id="3124" class="Symbol">:</a> <a id="3126" href="Agda.Primitive.html#408" class="Postulate">Level</a><a id="3131" class="Symbol">}</a> <a id="3133" href="Intro.html#3133" class="Bound">ℓ</a> <a id="3135" class="Symbol">(</a><a id="3136" href="Intro.html#3136" class="Bound">A</a> <a id="3138" class="Symbol">:</a> <a id="3140" href="Intro.html#2811" class="Function">Type</a> <a id="3145" href="Intro.html#3122" class="Bound">a</a><a id="3146" class="Symbol">)</a>
    <a id="3152" class="Symbol">:</a> <a id="3154" href="Intro.html#2811" class="Function">Type</a> <a id="3159" class="Symbol">(</a><a id="3160" href="Intro.html#3122" class="Bound">a</a> <a id="3162" href="Agda.Primitive.html#657" class="Primitive Operator">⊔</a> <a id="3164" href="Intro.html#3133" class="Bound">ℓ</a><a id="3165" class="Symbol">)</a>
  <a id="3169" class="Keyword">where</a>
  <a id="3177" class="Keyword">constructor</a> <a id="↑.Lift"></a><a id="3189" href="Intro.html#3189" class="InductiveConstructor">Lift</a>
  <a id="3196" class="Keyword">field</a>
    <a id="↑.lower"></a><a id="3206" href="Intro.html#3206" class="Field">lower</a> <a id="3212" class="Symbol">:</a> <a id="3214" href="Intro.html#3136" class="Bound">A</a>

<a id="3217" class="Keyword">open</a> <a id="3222" href="Intro.html#3119" class="Module">↑</a> <a id="3224" class="Keyword">public</a>
</pre>
...
<pre class="Agda">
<a id="3467" class="Keyword">variable</a>
  <a id="3478" href="Intro.html#3478" class="Generalizable">ℓ</a> <a id="3480" href="Intro.html#3480" class="Generalizable">ℓᵢ</a> <a id="3483" href="Intro.html#3483" class="Generalizable">ℓⱼ</a> <a id="3486" href="Intro.html#3486" class="Generalizable">ℓₖ</a> <a id="3489" class="Symbol">:</a> <a id="3491" href="Agda.Primitive.html#408" class="Postulate">Level</a>
</pre>
  ...
  <pre class="bibtex"
       ...
       data-url ="http://jonaprieto.github.io/mini-hott/Intro.tex"
  ></pre>
  </div>
  ...
  <div id="github-links">
    <div class="view-source">
        ...
        <a href="https://raw.githubusercontent.com/jonaprieto/mini-hott/master/src/Intro.tex" download target="_blank"><svg height="12" class="octicon octicon-file right left" viewBox="0 0 12 16" version="1.1" width="9" aria-hidden="true"><path fill-rule="evenodd" d="M6 5H2V4h4v1zM2 8h7V7H2v1zm0 2h7V9H2v1zm0 2h7v-1H2v1zm10-7.5V14c0 .55-.45 1-1 1H1c-.55 0-1-.45-1-1V2c0-.55.45-1 1-1h7.5L12 4.5zM11 5L8 2H1v12h10V5z"/></svg> .lagda </a>
        <a href="https://raw.githubusercontent.com/jonaprieto/mini-hott/master/docs/agda/Intro.tex" download target="_blank"><svg height="12" class="octicon octicon-file-code right left" viewBox="0 0 12 16" version="1.1" width="9" aria-hidden="true"><path fill-rule="evenodd" d="M8.5 1H1c-.55 0-1 .45-1 1v12c0 .55.45 1 1 1h10c.55 0 1-.45 1-1V4.5L8.5 1zM11 14H1V2h7l3 3v9zM5 6.98L3.5 8.5 5 10l-.5 1L2 8.5 4.5 6l.5.98zM7.5 6L10 8.5 7.5 11l-.5-.98L8.5 8.5 7 7l.5-1z"/></svg> .agda</a>
      
      <a href="https://github.com/jonaprieto/mini-hott/blob/master/srcIntro.tex" target="_blank"><svg height="12" class="octicon octicon-mark-github right left" viewBox="0 0 16 16" version="1.1" width="12" aria-hidden="true"><path fill-rule="evenodd" d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27 2-.27.68 0 1.36.09 2 .27 1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.013 8.013 0 0 0 16 8c0-4.42-3.58-8-8-8z"/></svg> Github</a>
