...
<pre class="Agda">
<a id="2778" class="Symbol">{-#</a> <a id="2782" class="Keyword">OPTIONS</a> <a id="2790" class="Pragma">--without-K</a> <a id="2802" class="Symbol">#-}</a>
</pre>
...
<pre class="Agda">
<a id="3132" class="Symbol">{-#</a> <a id="3136" class="Keyword">OPTIONS</a> <a id="3144" class="Pragma">--exact-split</a> <a id="3158" class="Symbol">#-}</a>
</pre>

<pre class="Agda">
<a id="3187" class="Keyword">open</a> <a id="3192" class="Keyword">import</a> <a id="3199" href="Agda.Primitive.html" class="Module">Agda.Primitive</a>
  <a id="3216" class="Keyword">using</a> <a id="3222" class="Symbol">(</a> <a id="3224" href="Agda.Primitive.html#408" class="Postulate">Level</a> <a id="3230" class="Symbol">;</a> <a id="3232" href="Agda.Primitive.html#627" class="Primitive">lsuc</a><a id="3236" class="Symbol">;</a> <a id="3238" href="Agda.Primitive.html#611" class="Primitive">lzero</a><a id="3243" class="Symbol">;</a> <a id="3245" href="Agda.Primitive.html#657" class="Primitive Operator">_⊔_</a> <a id="3249" class="Symbol">)</a> <a id="3251" class="Keyword">public</a>
</pre>
...
<pre class="Agda">
<a id="Type"></a><a id="3414" href="Intro.html#3414" class="Function">Type</a>
  <a id="3421" class="Symbol">:</a> <a id="3423" class="Symbol">(</a><a id="3424" href="Intro.html#3424" class="Bound">ℓ</a> <a id="3426" class="Symbol">:</a> <a id="3428" href="Agda.Primitive.html#408" class="Postulate">Level</a><a id="3433" class="Symbol">)</a>
  <a id="3437" class="Symbol">→</a> <a id="3439" class="PrimitiveType">Set</a> <a id="3443" class="Symbol">(</a><a id="3444" href="Agda.Primitive.html#627" class="Primitive">lsuc</a> <a id="3449" href="Intro.html#3424" class="Bound">ℓ</a><a id="3450" class="Symbol">)</a>

<a id="3453" href="Intro.html#3414" class="Function">Type</a> <a id="3458" href="Intro.html#3458" class="Bound">ℓ</a> <a id="3460" class="Symbol">=</a> <a id="3462" class="PrimitiveType">Set</a> <a id="3466" href="Intro.html#3458" class="Bound">ℓ</a>
</pre>

<pre class="Agda">
<a id="Type₀"></a><a id="3493" href="Intro.html#3493" class="Function">Type₀</a>
  <a id="3501" class="Symbol">:</a> <a id="3503" href="Intro.html#3414" class="Function">Type</a> <a id="3508" class="Symbol">(</a><a id="3509" href="Agda.Primitive.html#627" class="Primitive">lsuc</a> <a id="3514" href="Agda.Primitive.html#611" class="Primitive">lzero</a><a id="3519" class="Symbol">)</a>

<a id="3522" href="Intro.html#3493" class="Function">Type₀</a> <a id="3528" class="Symbol">=</a> <a id="3530" href="Intro.html#3414" class="Function">Type</a> <a id="3535" href="Agda.Primitive.html#611" class="Primitive">lzero</a>
</pre>

<pre class="Agda">
<a id="Type₁"></a><a id="3566" href="Intro.html#3566" class="Function">Type₁</a>
  <a id="3574" class="Symbol">:</a> <a id="3576" href="Intro.html#3414" class="Function">Type</a> <a id="3581" class="Symbol">(</a><a id="3582" href="Agda.Primitive.html#627" class="Primitive">lsuc</a> <a id="3587" class="Symbol">(</a><a id="3588" href="Agda.Primitive.html#627" class="Primitive">lsuc</a> <a id="3593" href="Agda.Primitive.html#611" class="Primitive">lzero</a><a id="3598" class="Symbol">))</a>

<a id="3602" href="Intro.html#3566" class="Function">Type₁</a> <a id="3608" class="Symbol">=</a> <a id="3610" href="Intro.html#3414" class="Function">Type</a> <a id="3615" class="Symbol">(</a><a id="3616" href="Agda.Primitive.html#627" class="Primitive">lsuc</a> <a id="3621" href="Agda.Primitive.html#611" class="Primitive">lzero</a><a id="3626" class="Symbol">)</a>
</pre>

The following type is to lift a type to a higher universe.

<pre class="Agda">
<a id="3713" class="Keyword">record</a>
  <a id="↑"></a><a id="3722" href="Intro.html#3722" class="Record">↑</a> <a id="3724" class="Symbol">{</a><a id="3725" href="Intro.html#3725" class="Bound">a</a> <a id="3727" class="Symbol">:</a> <a id="3729" href="Agda.Primitive.html#408" class="Postulate">Level</a><a id="3734" class="Symbol">}</a> <a id="3736" href="Intro.html#3736" class="Bound">ℓ</a> <a id="3738" class="Symbol">(</a><a id="3739" href="Intro.html#3739" class="Bound">A</a> <a id="3741" class="Symbol">:</a> <a id="3743" href="Intro.html#3414" class="Function">Type</a> <a id="3748" href="Intro.html#3725" class="Bound">a</a><a id="3749" class="Symbol">)</a>
    <a id="3755" class="Symbol">:</a> <a id="3757" href="Intro.html#3414" class="Function">Type</a> <a id="3762" class="Symbol">(</a><a id="3763" href="Intro.html#3725" class="Bound">a</a> <a id="3765" href="Agda.Primitive.html#657" class="Primitive Operator">⊔</a> <a id="3767" href="Intro.html#3736" class="Bound">ℓ</a><a id="3768" class="Symbol">)</a>
  <a id="3772" class="Keyword">where</a>
  <a id="3780" class="Keyword">constructor</a> <a id="↑.Lift"></a><a id="3792" href="Intro.html#3792" class="InductiveConstructor">Lift</a>
  <a id="3799" class="Keyword">field</a>
    <a id="↑.lower"></a><a id="3809" href="Intro.html#3809" class="Field">lower</a> <a id="3815" class="Symbol">:</a> <a id="3817" href="Intro.html#3739" class="Bound">A</a>

<a id="3820" class="Keyword">open</a> <a id="3825" href="Intro.html#3722" class="Module">↑</a> <a id="3827" class="Keyword">public</a>
</pre>
