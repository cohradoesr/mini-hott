...
<pre class="Agda">
<a id="2940" class="Symbol">{-#</a> <a id="2944" class="Keyword">OPTIONS</a> <a id="2952" class="Pragma">--without-K</a> <a id="2964" class="Symbol">#-}</a>
</pre>
...
<pre class="Agda">
<a id="3294" class="Symbol">{-#</a> <a id="3298" class="Keyword">OPTIONS</a> <a id="3306" class="Pragma">--exact-split</a> <a id="3320" class="Symbol">#-}</a>
</pre>

<pre class="Agda">
<a id="3349" class="Keyword">open</a> <a id="3354" class="Keyword">import</a> <a id="3361" href="Agda.Primitive.html" class="Module">Agda.Primitive</a>
  <a id="3378" class="Keyword">using</a> <a id="3384" class="Symbol">(</a> <a id="3386" href="Agda.Primitive.html#408" class="Postulate">Level</a> <a id="3392" class="Symbol">;</a> <a id="3394" href="Agda.Primitive.html#627" class="Primitive">lsuc</a><a id="3398" class="Symbol">;</a> <a id="3400" href="Agda.Primitive.html#611" class="Primitive">lzero</a><a id="3405" class="Symbol">;</a> <a id="3407" href="Agda.Primitive.html#657" class="Primitive Operator">_⊔_</a> <a id="3411" class="Symbol">)</a> <a id="3413" class="Keyword">public</a>
</pre>
...
<pre class="Agda">
<a id="Type"></a><a id="3576" href="Intro.html#3576" class="Function">Type</a>
  <a id="3583" class="Symbol">:</a> <a id="3585" class="Symbol">(</a><a id="3586" href="Intro.html#3586" class="Bound">ℓ</a> <a id="3588" class="Symbol">:</a> <a id="3590" href="Agda.Primitive.html#408" class="Postulate">Level</a><a id="3595" class="Symbol">)</a>
  <a id="3599" class="Symbol">→</a> <a id="3601" class="PrimitiveType">Set</a> <a id="3605" class="Symbol">(</a><a id="3606" href="Agda.Primitive.html#627" class="Primitive">lsuc</a> <a id="3611" href="Intro.html#3586" class="Bound">ℓ</a><a id="3612" class="Symbol">)</a>

<a id="3615" href="Intro.html#3576" class="Function">Type</a> <a id="3620" href="Intro.html#3620" class="Bound">ℓ</a> <a id="3622" class="Symbol">=</a> <a id="3624" class="PrimitiveType">Set</a> <a id="3628" href="Intro.html#3620" class="Bound">ℓ</a>
</pre>

<pre class="Agda">
<a id="Type₀"></a><a id="3655" href="Intro.html#3655" class="Function">Type₀</a>
  <a id="3663" class="Symbol">:</a> <a id="3665" href="Intro.html#3576" class="Function">Type</a> <a id="3670" class="Symbol">(</a><a id="3671" href="Agda.Primitive.html#627" class="Primitive">lsuc</a> <a id="3676" href="Agda.Primitive.html#611" class="Primitive">lzero</a><a id="3681" class="Symbol">)</a>

<a id="3684" href="Intro.html#3655" class="Function">Type₀</a> <a id="3690" class="Symbol">=</a> <a id="3692" href="Intro.html#3576" class="Function">Type</a> <a id="3697" href="Agda.Primitive.html#611" class="Primitive">lzero</a>
</pre>

<pre class="Agda">
<a id="Type₁"></a><a id="3728" href="Intro.html#3728" class="Function">Type₁</a>
  <a id="3736" class="Symbol">:</a> <a id="3738" href="Intro.html#3576" class="Function">Type</a> <a id="3743" class="Symbol">(</a><a id="3744" href="Agda.Primitive.html#627" class="Primitive">lsuc</a> <a id="3749" class="Symbol">(</a><a id="3750" href="Agda.Primitive.html#627" class="Primitive">lsuc</a> <a id="3755" href="Agda.Primitive.html#611" class="Primitive">lzero</a><a id="3760" class="Symbol">))</a>

<a id="3764" href="Intro.html#3728" class="Function">Type₁</a> <a id="3770" class="Symbol">=</a> <a id="3772" href="Intro.html#3576" class="Function">Type</a> <a id="3777" class="Symbol">(</a><a id="3778" href="Agda.Primitive.html#627" class="Primitive">lsuc</a> <a id="3783" href="Agda.Primitive.html#611" class="Primitive">lzero</a><a id="3788" class="Symbol">)</a>
</pre>

The following type is to lift a type to a higher universe.

<pre class="Agda">
<a id="3875" class="Keyword">record</a>
  <a id="↑"></a><a id="3884" href="Intro.html#3884" class="Record">↑</a> <a id="3886" class="Symbol">{</a><a id="3887" href="Intro.html#3887" class="Bound">a</a> <a id="3889" class="Symbol">:</a> <a id="3891" href="Agda.Primitive.html#408" class="Postulate">Level</a><a id="3896" class="Symbol">}</a> <a id="3898" href="Intro.html#3898" class="Bound">ℓ</a> <a id="3900" class="Symbol">(</a><a id="3901" href="Intro.html#3901" class="Bound">A</a> <a id="3903" class="Symbol">:</a> <a id="3905" href="Intro.html#3576" class="Function">Type</a> <a id="3910" href="Intro.html#3887" class="Bound">a</a><a id="3911" class="Symbol">)</a>
    <a id="3917" class="Symbol">:</a> <a id="3919" href="Intro.html#3576" class="Function">Type</a> <a id="3924" class="Symbol">(</a><a id="3925" href="Intro.html#3887" class="Bound">a</a> <a id="3927" href="Agda.Primitive.html#657" class="Primitive Operator">⊔</a> <a id="3929" href="Intro.html#3898" class="Bound">ℓ</a><a id="3930" class="Symbol">)</a>
  <a id="3934" class="Keyword">where</a>
  <a id="3942" class="Keyword">constructor</a> <a id="↑.Lift"></a><a id="3954" href="Intro.html#3954" class="InductiveConstructor">Lift</a>
  <a id="3961" class="Keyword">field</a>
    <a id="↑.lower"></a><a id="3971" href="Intro.html#3971" class="Field">lower</a> <a id="3977" class="Symbol">:</a> <a id="3979" href="Intro.html#3901" class="Bound">A</a>

<a id="3982" class="Keyword">open</a> <a id="3987" href="Intro.html#3884" class="Module">↑</a> <a id="3989" class="Keyword">public</a>
</pre>
