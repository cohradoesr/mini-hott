...
<pre class="Agda">
<a id="2649" class="Symbol">{-#</a> <a id="2653" class="Keyword">OPTIONS</a> <a id="2661" class="Pragma">--without-K</a> <a id="2673" class="Symbol">#-}</a>
</pre>
...
<pre class="Agda">
<a id="3003" class="Symbol">{-#</a> <a id="3007" class="Keyword">OPTIONS</a> <a id="3015" class="Pragma">--exact-split</a> <a id="3029" class="Symbol">#-}</a>
</pre>

<pre class="Agda">
<a id="3058" class="Keyword">open</a> <a id="3063" class="Keyword">import</a> <a id="3070" href="Agda.Primitive.html" class="Module">Agda.Primitive</a>
  <a id="3087" class="Keyword">using</a> <a id="3093" class="Symbol">(</a> <a id="3095" href="Agda.Primitive.html#408" class="Postulate">Level</a> <a id="3101" class="Symbol">;</a> <a id="3103" href="Agda.Primitive.html#627" class="Primitive">lsuc</a><a id="3107" class="Symbol">;</a> <a id="3109" href="Agda.Primitive.html#611" class="Primitive">lzero</a><a id="3114" class="Symbol">;</a> <a id="3116" href="Agda.Primitive.html#657" class="Primitive Operator">_⊔_</a> <a id="3120" class="Symbol">)</a> <a id="3122" class="Keyword">public</a>
</pre>
...
<pre class="Agda">
<a id="Type"></a><a id="3285" href="Intro.html#3285" class="Function">Type</a>
  <a id="3292" class="Symbol">:</a> <a id="3294" class="Symbol">(</a><a id="3295" href="Intro.html#3295" class="Bound">ℓ</a> <a id="3297" class="Symbol">:</a> <a id="3299" href="Agda.Primitive.html#408" class="Postulate">Level</a><a id="3304" class="Symbol">)</a>
  <a id="3308" class="Symbol">→</a> <a id="3310" class="PrimitiveType">Set</a> <a id="3314" class="Symbol">(</a><a id="3315" href="Agda.Primitive.html#627" class="Primitive">lsuc</a> <a id="3320" href="Intro.html#3295" class="Bound">ℓ</a><a id="3321" class="Symbol">)</a>

<a id="3324" href="Intro.html#3285" class="Function">Type</a> <a id="3329" href="Intro.html#3329" class="Bound">ℓ</a> <a id="3331" class="Symbol">=</a> <a id="3333" class="PrimitiveType">Set</a> <a id="3337" href="Intro.html#3329" class="Bound">ℓ</a>
</pre>

<pre class="Agda">
<a id="Type₀"></a><a id="3364" href="Intro.html#3364" class="Function">Type₀</a>
  <a id="3372" class="Symbol">:</a> <a id="3374" href="Intro.html#3285" class="Function">Type</a> <a id="3379" class="Symbol">(</a><a id="3380" href="Agda.Primitive.html#627" class="Primitive">lsuc</a> <a id="3385" href="Agda.Primitive.html#611" class="Primitive">lzero</a><a id="3390" class="Symbol">)</a>

<a id="3393" href="Intro.html#3364" class="Function">Type₀</a> <a id="3399" class="Symbol">=</a> <a id="3401" href="Intro.html#3285" class="Function">Type</a> <a id="3406" href="Agda.Primitive.html#611" class="Primitive">lzero</a>
</pre>

<pre class="Agda">
<a id="Type₁"></a><a id="3437" href="Intro.html#3437" class="Function">Type₁</a>
  <a id="3445" class="Symbol">:</a> <a id="3447" href="Intro.html#3285" class="Function">Type</a> <a id="3452" class="Symbol">(</a><a id="3453" href="Agda.Primitive.html#627" class="Primitive">lsuc</a> <a id="3458" class="Symbol">(</a><a id="3459" href="Agda.Primitive.html#627" class="Primitive">lsuc</a> <a id="3464" href="Agda.Primitive.html#611" class="Primitive">lzero</a><a id="3469" class="Symbol">))</a>

<a id="3473" href="Intro.html#3437" class="Function">Type₁</a> <a id="3479" class="Symbol">=</a> <a id="3481" href="Intro.html#3285" class="Function">Type</a> <a id="3486" class="Symbol">(</a><a id="3487" href="Agda.Primitive.html#627" class="Primitive">lsuc</a> <a id="3492" href="Agda.Primitive.html#611" class="Primitive">lzero</a><a id="3497" class="Symbol">)</a>
</pre>

The following type is to lift a type to a higher universe.

<pre class="Agda">
<a id="3584" class="Keyword">record</a>
  <a id="↑"></a><a id="3593" href="Intro.html#3593" class="Record">↑</a> <a id="3595" class="Symbol">{</a><a id="3596" href="Intro.html#3596" class="Bound">a</a> <a id="3598" class="Symbol">:</a> <a id="3600" href="Agda.Primitive.html#408" class="Postulate">Level</a><a id="3605" class="Symbol">}</a> <a id="3607" href="Intro.html#3607" class="Bound">ℓ</a> <a id="3609" class="Symbol">(</a><a id="3610" href="Intro.html#3610" class="Bound">A</a> <a id="3612" class="Symbol">:</a> <a id="3614" href="Intro.html#3285" class="Function">Type</a> <a id="3619" href="Intro.html#3596" class="Bound">a</a><a id="3620" class="Symbol">)</a>
    <a id="3626" class="Symbol">:</a> <a id="3628" href="Intro.html#3285" class="Function">Type</a> <a id="3633" class="Symbol">(</a><a id="3634" href="Intro.html#3596" class="Bound">a</a> <a id="3636" href="Agda.Primitive.html#657" class="Primitive Operator">⊔</a> <a id="3638" href="Intro.html#3607" class="Bound">ℓ</a><a id="3639" class="Symbol">)</a>
  <a id="3643" class="Keyword">where</a>
  <a id="3651" class="Keyword">constructor</a> <a id="↑.Lift"></a><a id="3663" href="Intro.html#3663" class="InductiveConstructor">Lift</a>
  <a id="3670" class="Keyword">field</a>
    <a id="↑.lower"></a><a id="3680" href="Intro.html#3680" class="Field">lower</a> <a id="3686" class="Symbol">:</a> <a id="3688" href="Intro.html#3610" class="Bound">A</a>

<a id="3691" class="Keyword">open</a> <a id="3696" href="Intro.html#3593" class="Module">↑</a> <a id="3698" class="Keyword">public</a>
</pre>
