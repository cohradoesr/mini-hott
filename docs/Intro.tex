...
<pre class="Agda">
<a id="2977" class="Symbol">{-#</a> <a id="2981" class="Keyword">OPTIONS</a> <a id="2989" class="Pragma">--without-K</a> <a id="3001" class="Symbol">#-}</a>
</pre>
...
<pre class="Agda">
<a id="3329" class="Symbol">{-#</a> <a id="3333" class="Keyword">OPTIONS</a> <a id="3341" class="Pragma">--exact-split</a> <a id="3355" class="Symbol">#-}</a>
</pre>

<pre class="Agda">
<a id="3384" class="Keyword">open</a> <a id="3389" class="Keyword">import</a> <a id="3396" href="Agda.Primitive.html" class="Module">Agda.Primitive</a>
  <a id="3413" class="Keyword">using</a> <a id="3419" class="Symbol">(</a> <a id="3421" href="Agda.Primitive.html#408" class="Postulate">Level</a> <a id="3427" class="Symbol">;</a> <a id="3429" href="Agda.Primitive.html#627" class="Primitive">lsuc</a><a id="3433" class="Symbol">;</a> <a id="3435" href="Agda.Primitive.html#611" class="Primitive">lzero</a><a id="3440" class="Symbol">;</a> <a id="3442" href="Agda.Primitive.html#657" class="Primitive Operator">_⊔_</a> <a id="3446" class="Symbol">)</a> <a id="3448" class="Keyword">public</a>
</pre>
...
<pre class="Agda">
<a id="Type"></a><a id="3611" href="Intro.html#3611" class="Function">Type</a>
  <a id="3618" class="Symbol">:</a> <a id="3620" class="Symbol">(</a><a id="3621" href="Intro.html#3621" class="Bound">ℓ</a> <a id="3623" class="Symbol">:</a> <a id="3625" href="Agda.Primitive.html#408" class="Postulate">Level</a><a id="3630" class="Symbol">)</a>
  <a id="3634" class="Symbol">→</a> <a id="3636" class="PrimitiveType">Set</a> <a id="3640" class="Symbol">(</a><a id="3641" href="Agda.Primitive.html#627" class="Primitive">lsuc</a> <a id="3646" href="Intro.html#3621" class="Bound">ℓ</a><a id="3647" class="Symbol">)</a>

<a id="3650" href="Intro.html#3611" class="Function">Type</a> <a id="3655" href="Intro.html#3655" class="Bound">ℓ</a> <a id="3657" class="Symbol">=</a> <a id="3659" class="PrimitiveType">Set</a> <a id="3663" href="Intro.html#3655" class="Bound">ℓ</a>
</pre>

<pre class="Agda">
<a id="Type₀"></a><a id="3690" href="Intro.html#3690" class="Function">Type₀</a>
  <a id="3698" class="Symbol">:</a> <a id="3700" href="Intro.html#3611" class="Function">Type</a> <a id="3705" class="Symbol">(</a><a id="3706" href="Agda.Primitive.html#627" class="Primitive">lsuc</a> <a id="3711" href="Agda.Primitive.html#611" class="Primitive">lzero</a><a id="3716" class="Symbol">)</a>

<a id="3719" href="Intro.html#3690" class="Function">Type₀</a> <a id="3725" class="Symbol">=</a> <a id="3727" href="Intro.html#3611" class="Function">Type</a> <a id="3732" href="Agda.Primitive.html#611" class="Primitive">lzero</a>
</pre>

<pre class="Agda">
<a id="Type₁"></a><a id="3763" href="Intro.html#3763" class="Function">Type₁</a>
  <a id="3771" class="Symbol">:</a> <a id="3773" href="Intro.html#3611" class="Function">Type</a> <a id="3778" class="Symbol">(</a><a id="3779" href="Agda.Primitive.html#627" class="Primitive">lsuc</a> <a id="3784" class="Symbol">(</a><a id="3785" href="Agda.Primitive.html#627" class="Primitive">lsuc</a> <a id="3790" href="Agda.Primitive.html#611" class="Primitive">lzero</a><a id="3795" class="Symbol">))</a>

<a id="3799" href="Intro.html#3763" class="Function">Type₁</a> <a id="3805" class="Symbol">=</a> <a id="3807" href="Intro.html#3611" class="Function">Type</a> <a id="3812" class="Symbol">(</a><a id="3813" href="Agda.Primitive.html#627" class="Primitive">lsuc</a> <a id="3818" href="Agda.Primitive.html#611" class="Primitive">lzero</a><a id="3823" class="Symbol">)</a>
</pre>

The following type is to lift a type to a higher universe.

<pre class="Agda">
<a id="3910" class="Keyword">record</a>
  <a id="↑"></a><a id="3919" href="Intro.html#3919" class="Record">↑</a> <a id="3921" class="Symbol">{</a><a id="3922" href="Intro.html#3922" class="Bound">a</a> <a id="3924" class="Symbol">:</a> <a id="3926" href="Agda.Primitive.html#408" class="Postulate">Level</a><a id="3931" class="Symbol">}</a> <a id="3933" href="Intro.html#3933" class="Bound">ℓ</a> <a id="3935" class="Symbol">(</a><a id="3936" href="Intro.html#3936" class="Bound">A</a> <a id="3938" class="Symbol">:</a> <a id="3940" href="Intro.html#3611" class="Function">Type</a> <a id="3945" href="Intro.html#3922" class="Bound">a</a><a id="3946" class="Symbol">)</a>
    <a id="3952" class="Symbol">:</a> <a id="3954" href="Intro.html#3611" class="Function">Type</a> <a id="3959" class="Symbol">(</a><a id="3960" href="Intro.html#3922" class="Bound">a</a> <a id="3962" href="Agda.Primitive.html#657" class="Primitive Operator">⊔</a> <a id="3964" href="Intro.html#3933" class="Bound">ℓ</a><a id="3965" class="Symbol">)</a>
  <a id="3969" class="Keyword">where</a>
  <a id="3977" class="Keyword">constructor</a> <a id="↑.Lift"></a><a id="3989" href="Intro.html#3989" class="InductiveConstructor">Lift</a>
  <a id="3996" class="Keyword">field</a>
    <a id="↑.lower"></a><a id="4006" href="Intro.html#4006" class="Field">lower</a> <a id="4012" class="Symbol">:</a> <a id="4014" href="Intro.html#3936" class="Bound">A</a>

<a id="4017" class="Keyword">open</a> <a id="4022" href="Intro.html#3919" class="Module">↑</a> <a id="4024" class="Keyword">public</a>
</pre>
