...
<pre class="Agda">
<a id="2704" class="Symbol">{-#</a> <a id="2708" class="Keyword">OPTIONS</a> <a id="2716" class="Pragma">--without-K</a> <a id="2728" class="Symbol">#-}</a>
</pre>
...
<pre class="Agda">
<a id="2958" class="Keyword">open</a> <a id="2963" class="Keyword">import</a> <a id="2970" href="Agda.Primitive.html" class="Module">Agda.Primitive</a>
  <a id="2987" class="Keyword">using</a> <a id="2993" class="Symbol">(</a> <a id="2995" href="Agda.Primitive.html#408" class="Postulate">Level</a> <a id="3001" class="Symbol">;</a> <a id="3003" href="Agda.Primitive.html#627" class="Primitive">lsuc</a><a id="3007" class="Symbol">;</a> <a id="3009" href="Agda.Primitive.html#611" class="Primitive">lzero</a><a id="3014" class="Symbol">;</a> <a id="3016" href="Agda.Primitive.html#657" class="Primitive Operator">_⊔_</a> <a id="3020" class="Symbol">)</a> <a id="3022" class="Keyword">public</a>
</pre>
...
<pre class="Agda">
<a id="Type"></a><a id="3185" href="Intro.html#3185" class="Function">Type</a>
  <a id="3192" class="Symbol">:</a> <a id="3194" class="Symbol">(</a><a id="3195" href="Intro.html#3195" class="Bound">ℓ</a> <a id="3197" class="Symbol">:</a> <a id="3199" href="Agda.Primitive.html#408" class="Postulate">Level</a><a id="3204" class="Symbol">)</a>
  <a id="3208" class="Symbol">→</a> <a id="3210" class="PrimitiveType">Set</a> <a id="3214" class="Symbol">(</a><a id="3215" href="Agda.Primitive.html#627" class="Primitive">lsuc</a> <a id="3220" href="Intro.html#3195" class="Bound">ℓ</a><a id="3221" class="Symbol">)</a>

<a id="3224" href="Intro.html#3185" class="Function">Type</a> <a id="3229" href="Intro.html#3229" class="Bound">ℓ</a> <a id="3231" class="Symbol">=</a> <a id="3233" class="PrimitiveType">Set</a> <a id="3237" href="Intro.html#3229" class="Bound">ℓ</a>
</pre>

<pre class="Agda">
<a id="Type₀"></a><a id="3264" href="Intro.html#3264" class="Function">Type₀</a>
  <a id="3272" class="Symbol">:</a> <a id="3274" href="Intro.html#3185" class="Function">Type</a> <a id="3279" class="Symbol">(</a><a id="3280" href="Agda.Primitive.html#627" class="Primitive">lsuc</a> <a id="3285" href="Agda.Primitive.html#611" class="Primitive">lzero</a><a id="3290" class="Symbol">)</a>

<a id="3293" href="Intro.html#3264" class="Function">Type₀</a> <a id="3299" class="Symbol">=</a> <a id="3301" href="Intro.html#3185" class="Function">Type</a> <a id="3306" href="Agda.Primitive.html#611" class="Primitive">lzero</a>
</pre>

<pre class="Agda">
<a id="Type₁"></a><a id="3337" href="Intro.html#3337" class="Function">Type₁</a>
  <a id="3345" class="Symbol">:</a> <a id="3347" href="Intro.html#3185" class="Function">Type</a> <a id="3352" class="Symbol">(</a><a id="3353" href="Agda.Primitive.html#627" class="Primitive">lsuc</a> <a id="3358" class="Symbol">(</a><a id="3359" href="Agda.Primitive.html#627" class="Primitive">lsuc</a> <a id="3364" href="Agda.Primitive.html#611" class="Primitive">lzero</a><a id="3369" class="Symbol">))</a>

<a id="3373" href="Intro.html#3337" class="Function">Type₁</a> <a id="3379" class="Symbol">=</a> <a id="3381" href="Intro.html#3185" class="Function">Type</a> <a id="3386" class="Symbol">(</a><a id="3387" href="Agda.Primitive.html#627" class="Primitive">lsuc</a> <a id="3392" href="Agda.Primitive.html#611" class="Primitive">lzero</a><a id="3397" class="Symbol">)</a>
</pre>

The following type is to lift a type to a higher universe.

<pre class="Agda">
<a id="3484" class="Keyword">record</a>
  <a id="↑"></a><a id="3493" href="Intro.html#3493" class="Record">↑</a> <a id="3495" class="Symbol">{</a><a id="3496" href="Intro.html#3496" class="Bound">a</a> <a id="3498" class="Symbol">:</a> <a id="3500" href="Agda.Primitive.html#408" class="Postulate">Level</a><a id="3505" class="Symbol">}</a> <a id="3507" href="Intro.html#3507" class="Bound">ℓ</a> <a id="3509" class="Symbol">(</a><a id="3510" href="Intro.html#3510" class="Bound">A</a> <a id="3512" class="Symbol">:</a> <a id="3514" href="Intro.html#3185" class="Function">Type</a> <a id="3519" href="Intro.html#3496" class="Bound">a</a><a id="3520" class="Symbol">)</a>
    <a id="3526" class="Symbol">:</a> <a id="3528" href="Intro.html#3185" class="Function">Type</a> <a id="3533" class="Symbol">(</a><a id="3534" href="Intro.html#3496" class="Bound">a</a> <a id="3536" href="Agda.Primitive.html#657" class="Primitive Operator">⊔</a> <a id="3538" href="Intro.html#3507" class="Bound">ℓ</a><a id="3539" class="Symbol">)</a>
  <a id="3543" class="Keyword">where</a>
  <a id="3551" class="Keyword">constructor</a> <a id="↑.Lift"></a><a id="3563" href="Intro.html#3563" class="InductiveConstructor">Lift</a>
  <a id="3570" class="Keyword">field</a>
    <a id="↑.lower"></a><a id="3580" href="Intro.html#3580" class="Field">lower</a> <a id="3586" class="Symbol">:</a> <a id="3588" href="Intro.html#3510" class="Bound">A</a>

<a id="3591" class="Keyword">open</a> <a id="3596" href="Intro.html#3493" class="Module">↑</a> <a id="3598" class="Keyword">public</a>
</pre>
