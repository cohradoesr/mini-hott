...
<pre class="Agda">
<a id="2903" class="Keyword">open</a> <a id="2908" class="Keyword">import</a> <a id="2915" href="Agda.Primitive.html" class="Module">Agda.Primitive</a>
  <a id="2932" class="Keyword">using</a> <a id="2938" class="Symbol">(</a> <a id="2940" href="Agda.Primitive.html#408" class="Postulate">Level</a> <a id="2946" class="Symbol">;</a> <a id="2948" href="Agda.Primitive.html#627" class="Primitive">lsuc</a><a id="2952" class="Symbol">;</a> <a id="2954" href="Agda.Primitive.html#611" class="Primitive">lzero</a><a id="2959" class="Symbol">;</a> <a id="2961" href="Agda.Primitive.html#657" class="Primitive Operator">_⊔_</a> <a id="2965" class="Symbol">)</a> <a id="2967" class="Keyword">public</a>
</pre>
...
<pre class="Agda">
<a id="Type"></a><a id="3130" href="Intro.html#3130" class="Function">Type</a>
  <a id="3137" class="Symbol">:</a> <a id="3139" class="Symbol">(</a><a id="3140" href="Intro.html#3140" class="Bound">ℓ</a> <a id="3142" class="Symbol">:</a> <a id="3144" href="Agda.Primitive.html#408" class="Postulate">Level</a><a id="3149" class="Symbol">)</a>
  <a id="3153" class="Symbol">→</a> <a id="3155" class="PrimitiveType">Set</a> <a id="3159" class="Symbol">(</a><a id="3160" href="Agda.Primitive.html#627" class="Primitive">lsuc</a> <a id="3165" href="Intro.html#3140" class="Bound">ℓ</a><a id="3166" class="Symbol">)</a>

<a id="3169" href="Intro.html#3130" class="Function">Type</a> <a id="3174" href="Intro.html#3174" class="Bound">ℓ</a> <a id="3176" class="Symbol">=</a> <a id="3178" class="PrimitiveType">Set</a> <a id="3182" href="Intro.html#3174" class="Bound">ℓ</a>
</pre>

<pre class="Agda">
<a id="Type₀"></a><a id="3209" href="Intro.html#3209" class="Function">Type₀</a>
  <a id="3217" class="Symbol">:</a> <a id="3219" href="Intro.html#3130" class="Function">Type</a> <a id="3224" class="Symbol">(</a><a id="3225" href="Agda.Primitive.html#627" class="Primitive">lsuc</a> <a id="3230" href="Agda.Primitive.html#611" class="Primitive">lzero</a><a id="3235" class="Symbol">)</a>

<a id="3238" href="Intro.html#3209" class="Function">Type₀</a> <a id="3244" class="Symbol">=</a> <a id="3246" href="Intro.html#3130" class="Function">Type</a> <a id="3251" href="Agda.Primitive.html#611" class="Primitive">lzero</a>
</pre>

<pre class="Agda">
<a id="Type₁"></a><a id="3282" href="Intro.html#3282" class="Function">Type₁</a>
  <a id="3290" class="Symbol">:</a> <a id="3292" href="Intro.html#3130" class="Function">Type</a> <a id="3297" class="Symbol">(</a><a id="3298" href="Agda.Primitive.html#627" class="Primitive">lsuc</a> <a id="3303" class="Symbol">(</a><a id="3304" href="Agda.Primitive.html#627" class="Primitive">lsuc</a> <a id="3309" href="Agda.Primitive.html#611" class="Primitive">lzero</a><a id="3314" class="Symbol">))</a>

<a id="3318" href="Intro.html#3282" class="Function">Type₁</a> <a id="3324" class="Symbol">=</a> <a id="3326" href="Intro.html#3130" class="Function">Type</a> <a id="3331" class="Symbol">(</a><a id="3332" href="Agda.Primitive.html#627" class="Primitive">lsuc</a> <a id="3337" href="Agda.Primitive.html#611" class="Primitive">lzero</a><a id="3342" class="Symbol">)</a>
</pre>

The following type is to lift a type to a higher universe.

<pre class="Agda">
<a id="3429" class="Keyword">record</a>
  <a id="↑"></a><a id="3438" href="Intro.html#3438" class="Record">↑</a> <a id="3440" class="Symbol">{</a><a id="3441" href="Intro.html#3441" class="Bound">a</a> <a id="3443" class="Symbol">:</a> <a id="3445" href="Agda.Primitive.html#408" class="Postulate">Level</a><a id="3450" class="Symbol">}</a> <a id="3452" href="Intro.html#3452" class="Bound">ℓ</a> <a id="3454" class="Symbol">(</a><a id="3455" href="Intro.html#3455" class="Bound">A</a> <a id="3457" class="Symbol">:</a> <a id="3459" href="Intro.html#3130" class="Function">Type</a> <a id="3464" href="Intro.html#3441" class="Bound">a</a><a id="3465" class="Symbol">)</a>
    <a id="3471" class="Symbol">:</a> <a id="3473" href="Intro.html#3130" class="Function">Type</a> <a id="3478" class="Symbol">(</a><a id="3479" href="Intro.html#3441" class="Bound">a</a> <a id="3481" href="Agda.Primitive.html#657" class="Primitive Operator">⊔</a> <a id="3483" href="Intro.html#3452" class="Bound">ℓ</a><a id="3484" class="Symbol">)</a>
  <a id="3488" class="Keyword">where</a>
  <a id="3496" class="Keyword">constructor</a> <a id="↑.Lift"></a><a id="3508" href="Intro.html#3508" class="InductiveConstructor">Lift</a>
  <a id="3515" class="Keyword">field</a>
    <a id="↑.lower"></a><a id="3525" href="Intro.html#3525" class="Field">lower</a> <a id="3531" class="Symbol">:</a> <a id="3533" href="Intro.html#3455" class="Bound">A</a>

<a id="3536" class="Keyword">open</a> <a id="3541" href="Intro.html#3438" class="Module">↑</a> <a id="3543" class="Keyword">public</a>
</pre>
