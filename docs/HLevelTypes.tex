...
<a id="657" href="HLevelTypes.html#603" class="Function">isContr</a> <a id="665" href="HLevelTypes.html#665" class="Bound">A</a> <a id="667" class="Symbol">=</a> <a id="669" href="BasicTypes.html#1680" class="Function">Σ</a> <a id="671" href="HLevelTypes.html#665" class="Bound">A</a> <a id="673" class="Symbol">(λ</a> <a id="676" href="HLevelTypes.html#676" class="Bound">a</a> <a id="678" class="Symbol">→</a> <a id="680" class="Symbol">((</a><a id="682" href="HLevelTypes.html#682" class="Bound">x</a> <a id="684" class="Symbol">:</a> <a id="686" href="HLevelTypes.html#665" class="Bound">A</a><a id="687" class="Symbol">)</a> <a id="689" class="Symbol">→</a> <a id="691" href="HLevelTypes.html#676" class="Bound">a</a> <a id="693" href="BasicTypes.html#4284" class="Datatype Operator">==</a> <a id="696" href="HLevelTypes.html#682" class="Bound">x</a><a id="697" class="Symbol">))</a>
</pre>
...
<a id="allAreCenter"></a><a id="880" href="HLevelTypes.html#880" class="Function">allAreCenter</a>
  ...
  <a id="957" class="Symbol">→</a> <a id="959" class="Symbol">(∀</a> <a id="962" class="Symbol">(</a><a id="963" href="HLevelTypes.html#963" class="Bound">c₂</a> <a id="966" class="Symbol">:</a> <a id="968" href="HLevelTypes.html#904" class="Bound">A</a><a id="969" class="Symbol">)</a> <a id="971" class="Symbol">→</a> <a id="973" class="Symbol">(∀</a> <a id="976" class="Symbol">(</a><a id="977" href="HLevelTypes.html#977" class="Bound">x</a> <a id="979" class="Symbol">:</a> <a id="981" href="HLevelTypes.html#904" class="Bound">A</a><a id="982" class="Symbol">)</a> <a id="984" class="Symbol">→</a> <a id="986" href="HLevelTypes.html#963" class="Bound">c₂</a> <a id="989" href="BasicTypes.html#4284" class="Datatype Operator">==</a> <a id="992" href="HLevelTypes.html#977" class="Bound">x</a><a id="993" class="Symbol">))</a>

<a id="997" href="HLevelTypes.html#880" class="Function">allAreCenter</a> <a id="1010" href="HLevelTypes.html#1010" class="Bound">c₁</a> <a id="1013" href="HLevelTypes.html#1013" class="Bound">f</a> <a id="1015" href="HLevelTypes.html#1015" class="Bound">c₂</a> <a id="1018" href="HLevelTypes.html#1018" class="Bound">x</a> <a id="1020" class="Symbol">=</a> <a id="1022" href="BasicTypes.html#4734" class="Function">sym</a> <a id="1026" class="Symbol">(</a><a id="1027" href="HLevelTypes.html#1013" class="Bound">f</a> <a id="1029" href="HLevelTypes.html#1015" class="Bound">c₂</a><a id="1031" class="Symbol">)</a> <a id="1033" href="BasicFunctions.html#3893" class="Function Operator">·</a> <a id="1035" class="Symbol">(</a><a id="1036" href="HLevelTypes.html#1013" class="Bound">f</a> <a id="1038" href="HLevelTypes.html#1018" class="Bound">x</a><a id="1039" class="Symbol">)</a>
</pre>
...
<a id="is-prop"></a><a id="1295" href="HLevelTypes.html#1295" class="Function">is-prop</a>         <a id="1311" class="Symbol">=</a> <a id="1313" href="HLevelTypes.html#1162" class="Function">isProp</a>
</pre>

<pre class="Agda">
<a id="hProp"></a><a id="1345" href="HLevelTypes.html#1345" class="Function">hProp</a>
  <a id="1353" class="Symbol">:</a> <a id="1355" class="Symbol">∀</a> <a id="1357" class="Symbol">{</a><a id="1358" href="HLevelTypes.html#1358" class="Bound">ℓ</a><a id="1359" class="Symbol">}</a> <a id="1361" class="Symbol">→</a> <a id="1363" href="Intro.html#1803" class="Function">Type</a> <a id="1368" class="Symbol">(</a><a id="1369" href="Agda.Primitive.html#627" class="Primitive">lsuc</a> <a id="1374" href="HLevelTypes.html#1358" class="Bound">ℓ</a><a id="1375" class="Symbol">)</a>

<a id="1378" href="HLevelTypes.html#1345" class="Function">hProp</a> <a id="1384" class="Symbol">{</a><a id="1385" href="HLevelTypes.html#1385" class="Bound">ℓ</a><a id="1386" class="Symbol">}</a> <a id="1388" class="Symbol">=</a> <a id="1390" href="BasicTypes.html#1497" class="Record">∑</a> <a id="1392" class="Symbol">(</a><a id="1393" href="Intro.html#1803" class="Function">Type</a> <a id="1398" href="HLevelTypes.html#1385" class="Bound">ℓ</a><a id="1399" class="Symbol">)</a> <a id="1401" href="HLevelTypes.html#1162" class="Function">isProp</a>
</pre>
...
<pre class="Agda">
<a id="isSet"></a><a id="1682" href="HLevelTypes.html#1682" class="Function">isSet</a>
  <a id="1690" class="Symbol">:</a> <a id="1692" href="Intro.html#1803" class="Function">Type</a> <a id="1697" href="Intro.html#2243" class="Generalizable">ℓ</a> <a id="1699" class="Symbol">→</a> <a id="1701" href="Intro.html#1803" class="Function">Type</a> <a id="1706" href="Intro.html#2243" class="Generalizable">ℓ</a>
<a id="1708" href="HLevelTypes.html#1682" class="Function">isSet</a> <a id="1714" href="HLevelTypes.html#1714" class="Bound">A</a> <a id="1716" class="Symbol">=</a> <a id="1718" class="Symbol">(</a><a id="1719" href="HLevelTypes.html#1719" class="Bound">x</a> <a id="1721" href="HLevelTypes.html#1721" class="Bound">y</a> <a id="1723" class="Symbol">:</a> <a id="1725" href="HLevelTypes.html#1714" class="Bound">A</a><a id="1726" class="Symbol">)</a> <a id="1728" class="Symbol">→</a> <a id="1730" href="HLevelTypes.html#1162" class="Function">isProp</a> <a id="1737" class="Symbol">(</a><a id="1738" href="HLevelTypes.html#1719" class="Bound">x</a> <a id="1740" href="BasicTypes.html#4284" class="Datatype Operator">==</a> <a id="1743" href="HLevelTypes.html#1721" class="Bound">y</a><a id="1744" class="Symbol">)</a>
</pre>

Synonyms:

<pre class="Agda">
<a id="is-set"></a><a id="1782" href="HLevelTypes.html#1782" class="Function">is-set</a> <a id="1789" class="Symbol">=</a> <a id="1791" href="HLevelTypes.html#1682" class="Function">isSet</a>
</pre>

The type of sets

<pre class="Agda">
<a id="hSet"></a><a id="1840" href="HLevelTypes.html#1840" class="Function">hSet</a>
  <a id="1847" class="Symbol">:</a> <a id="1849" href="Intro.html#1803" class="Function">Type</a> <a id="1854" class="Symbol">(</a><a id="1855" href="Agda.Primitive.html#627" class="Primitive">lsuc</a> <a id="1860" href="Intro.html#2243" class="Generalizable">ℓ</a><a id="1861" class="Symbol">)</a>

<a id="1864" href="HLevelTypes.html#1840" class="Function">hSet</a> <a id="1869" class="Symbol">{</a><a id="1870" href="HLevelTypes.html#1870" class="Bound">ℓ</a><a id="1871" class="Symbol">}</a> <a id="1873" class="Symbol">=</a> <a id="1875" href="BasicTypes.html#1497" class="Record">∑</a> <a id="1877" class="Symbol">(</a><a id="1878" href="Intro.html#1803" class="Function">Type</a> <a id="1883" href="HLevelTypes.html#1870" class="Bound">ℓ</a><a id="1884" class="Symbol">)</a> <a id="1886" href="HLevelTypes.html#1682" class="Function">isSet</a>
</pre>

### Groupoids

<pre class="Agda">
<a id="isGroupoid"></a><a id="1932" href="HLevelTypes.html#1932" class="Function">isGroupoid</a>
  <a id="1945" class="Symbol">:</a> <a id="1947" href="Intro.html#1803" class="Function">Type</a> <a id="1952" href="Intro.html#2243" class="Generalizable">ℓ</a> <a id="1954" class="Symbol">→</a> <a id="1956" href="Intro.html#1803" class="Function">Type</a> <a id="1961" href="Intro.html#2243" class="Generalizable">ℓ</a>

<a id="1964" href="HLevelTypes.html#1932" class="Function">isGroupoid</a> <a id="1975" href="HLevelTypes.html#1975" class="Bound">A</a>  <a id="1978" class="Symbol">=</a> <a id="1980" class="Symbol">(</a><a id="1981" href="HLevelTypes.html#1981" class="Bound">a₀</a> <a id="1984" href="HLevelTypes.html#1984" class="Bound">a₁</a> <a id="1987" class="Symbol">:</a> <a id="1989" href="HLevelTypes.html#1975" class="Bound">A</a><a id="1990" class="Symbol">)</a> <a id="1992" class="Symbol">→</a> <a id="1994" href="HLevelTypes.html#1682" class="Function">isSet</a> <a id="2000" class="Symbol">(</a><a id="2001" href="HLevelTypes.html#1981" class="Bound">a₀</a> <a id="2004" href="BasicTypes.html#4470" class="Function Operator">≡</a> <a id="2006" href="HLevelTypes.html#1984" class="Bound">a₁</a><a id="2008" class="Symbol">)</a>
</pre>

Synonyms:

<pre class="Agda">
<a id="is-groupoid"></a><a id="2046" href="HLevelTypes.html#2046" class="Function">is-groupoid</a> <a id="2058" class="Symbol">=</a> <a id="2060" href="HLevelTypes.html#1932" class="Function">isGroupoid</a>
</pre>

<pre class="Agda">
<a id="Groupoid"></a><a id="2096" href="HLevelTypes.html#2096" class="Function">Groupoid</a>
  <a id="2107" class="Symbol">:</a> <a id="2109" href="Intro.html#1803" class="Function">Type</a> <a id="2114" class="Symbol">(</a><a id="2115" href="Agda.Primitive.html#627" class="Primitive">lsuc</a> <a id="2120" href="Intro.html#2243" class="Generalizable">ℓ</a><a id="2121" class="Symbol">)</a>
<a id="2123" href="HLevelTypes.html#2096" class="Function">Groupoid</a> <a id="2132" class="Symbol">{</a><a id="2133" href="HLevelTypes.html#2133" class="Bound">ℓ</a><a id="2134" class="Symbol">}</a> <a id="2136" class="Symbol">=</a> <a id="2138" href="BasicTypes.html#1497" class="Record">∑</a> <a id="2140" class="Symbol">(</a><a id="2141" href="Intro.html#1803" class="Function">Type</a> <a id="2146" href="HLevelTypes.html#2133" class="Bound">ℓ</a><a id="2147" class="Symbol">)</a> <a id="2149" href="HLevelTypes.html#1932" class="Function">isGroupoid</a>
</pre>
