...
<div class="post">
  ...
  <div class="hide" >
<pre class="Agda">
<a id="178" class="Symbol">{-#</a> <a id="182" class="Keyword">OPTIONS</a> <a id="190" class="Pragma">--without-K</a> <a id="202" class="Symbol">#-}</a>
<a id="206" class="Keyword">open</a> <a id="211" class="Keyword">import</a> <a id="218" href="TransportLemmas.html" class="Module">TransportLemmas</a>
<a id="234" class="Keyword">open</a> <a id="239" class="Keyword">import</a> <a id="246" href="EquivalenceType.html" class="Module">EquivalenceType</a>
<a id="262" class="Keyword">open</a> <a id="267" class="Keyword">import</a> <a id="274" href="HLevelTypes.html" class="Module">HLevelTypes</a>
</pre>
</div>
...
<pre class="Agda">
<a id="332" class="Keyword">module</a> <a id="339" href="RelationType.html" class="Module">RelationType</a> <a id="352" class="Keyword">where</a>

  <a id="361" class="Keyword">record</a> <a id="Rel"></a><a id="368" href="RelationType.html#368" class="Record">Rel</a> <a id="372" class="Symbol">{</a><a id="373" href="RelationType.html#373" class="Bound">ℓ</a> <a id="375" class="Symbol">:</a> <a id="377" href="Agda.Primitive.html#408" class="Postulate">Level</a><a id="382" class="Symbol">}</a> <a id="384" class="Symbol">(</a><a id="385" href="RelationType.html#385" class="Bound">A</a> <a id="387" class="Symbol">:</a> <a id="389" href="Intro.html#2931" class="Function">Type</a> <a id="394" href="RelationType.html#373" class="Bound">ℓ</a><a id="395" class="Symbol">)</a> <a id="397" class="Symbol">:</a> <a id="399" href="Intro.html#2931" class="Function">Type</a> <a id="404" class="Symbol">(</a><a id="405" href="Agda.Primitive.html#627" class="Primitive">lsuc</a> <a id="410" href="RelationType.html#373" class="Bound">ℓ</a><a id="411" class="Symbol">)</a> <a id="413" class="Keyword">where</a>
    <a id="423" class="Keyword">field</a>
      <a id="Rel.R"></a><a id="435" href="RelationType.html#435" class="Field">R</a>     <a id="441" class="Symbol">:</a> <a id="443" href="RelationType.html#385" class="Bound">A</a> <a id="445" class="Symbol">→</a> <a id="447" href="RelationType.html#385" class="Bound">A</a> <a id="449" class="Symbol">→</a> <a id="451" href="Intro.html#2931" class="Function">Type</a> <a id="456" href="RelationType.html#373" class="Bound">ℓ</a>
      <a id="Rel.Rprop"></a><a id="464" href="RelationType.html#464" class="Field">Rprop</a> <a id="470" class="Symbol">:</a> <a id="472" class="Symbol">(</a><a id="473" href="RelationType.html#473" class="Bound">a</a> <a id="475" href="RelationType.html#475" class="Bound">b</a> <a id="477" class="Symbol">:</a> <a id="479" href="RelationType.html#385" class="Bound">A</a><a id="480" class="Symbol">)</a> <a id="482" class="Symbol">→</a> <a id="484" href="HLevelTypes.html#1205" class="Function">isProp</a> <a id="491" class="Symbol">(</a><a id="492" href="RelationType.html#435" class="Field">R</a> <a id="494" href="RelationType.html#473" class="Bound">a</a> <a id="496" href="RelationType.html#475" class="Bound">b</a><a id="497" class="Symbol">)</a>
  <a id="501" class="Keyword">open</a> <a id="506" href="RelationType.html#368" class="Module">Rel</a> <a id="510" class="Symbol"></a> <a id="518" class="Keyword">public</a>
</pre>
  ...
  <div id="github-links">
    <div class="view-source">
      ...
      <a href="https://github.com/jonaprieto/mini-hott/blob/master/srcRelationType.tex" target="_blank"><svg height="12" class="octicon octicon-mark-github right left" viewBox="0 0 16 16" version="1.1" width="12" aria-hidden="true"><path fill-rule="evenodd" d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27 2-.27.68 0 1.36.09 2 .27 1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.013 8.013 0 0 0 16 8c0-4.42-3.58-8-8-8z"/></svg> Github</a>
