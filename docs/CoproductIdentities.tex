...
<a id="∑-≡"></a><a id="495" href="CoproductIdentities.html#495" class="Function">∑-≡</a>
  <a id="501" class="Symbol">:</a> <a id="503" class="Symbol">∀</a> <a id="505" class="Symbol">{</a><a id="506" href="CoproductIdentities.html#506" class="Bound">A</a> <a id="508" class="Symbol">:</a> <a id="510" href="Intro.html#1943" class="Function">Type</a> <a id="515" href="Intro.html#2497" class="Generalizable">ℓᵢ</a><a id="517" class="Symbol">}</a>
  <a id="521" class="Symbol">→</a> <a id="523" class="Symbol">(</a><a id="524" href="CoproductIdentities.html#524" class="Bound">B</a> <a id="526" class="Symbol">:</a> <a id="528" href="CoproductIdentities.html#506" class="Bound">A</a> <a id="530" class="Symbol">→</a> <a id="532" href="Intro.html#1943" class="Function">Type</a> <a id="537" href="Intro.html#2500" class="Generalizable">ℓⱼ</a><a id="539" class="Symbol">)</a>
...
<a id="π₁-≡"></a><a id="703" href="CoproductIdentities.html#703" class="Function">π₁-≡</a>
  <a id="710" class="Symbol">:</a> <a id="712" class="Symbol">∀</a> <a id="714" class="Symbol">{</a><a id="715" href="CoproductIdentities.html#715" class="Bound">A</a> <a id="717" class="Symbol">:</a> <a id="719" href="Intro.html#1943" class="Function">Type</a> <a id="724" href="Intro.html#2497" class="Generalizable">ℓᵢ</a><a id="726" class="Symbol">}</a> <a id="728" class="Symbol">(</a><a id="729" href="CoproductIdentities.html#729" class="Bound">B</a> <a id="731" class="Symbol">:</a> <a id="733" href="CoproductIdentities.html#715" class="Bound">A</a> <a id="735" class="Bound">→</a> <a id="737" href="Intro.html#1943" class="Function">Ty</a><a id="739" href="Intro.html#1943" class="Bound">p</a><a id="740" href="Intro.html#1943" class="Function">e</a><a id="741" class="Function"> </a><a id="742" href="Intro.html#2500" class="Function">ℓⱼ</a><a id="744" class="Function">)
...
<a id="π₂-≡"></a><a id="860" href="CoproductIdentities.html#860" class="Function">π₂-≡</a>
  <a id="867" class="Symbol">:</a> <a id="869" class="Symbol">{</a><a id="870" href="CoproductIdentities.html#870" class="Bound">A</a> <a id="872" class="Symbol">:</a> <a id="874" href="Intro.html#1943" class="Function">Type</a> <a id="879" href="Intro.html#2497" class="Generalizable">ℓᵢ</a><a id="881" class="Symbol">}</a>
  <a id="885" class="Symbol">→</a> <a id="887" class="Symbol">(</a><a id="888" href="CoproductIdentities.html#888" class="Bound">B</a> <a id="890" class="Symbol">:</a> <a id="892" href="CoproductIdentities.html#870" class="Bound">A</a> <a id="894" class="Symbol">→</a> <a id="896" href="Intro.html#1943" class="Function">Type</a> <a id="901" href="Intro.html#2500" class="Generalizable">ℓⱼ</a><a id="903" class="Symbol">)</a>
...
<a id="∑-map"></a><a id="1071" href="CoproductIdentities.html#1071" class="Function">∑-map</a>
  <a id="1079" class="Symbol">:</a> <a id="1081" class="Symbol">{</a><a id="1082" href="CoproductIdentities.html#1082" class="Bound">A</a> <a id="1084" class="Symbol">:</a> <a id="1086" href="Intro.html#1943" class="Function">Type</a> <a id="1091" href="Intro.html#2497" class="Generalizable">ℓᵢ</a><a id="1093" class="Symbol">}</a>  <a id="1096" class="Symbol">{</a><a id="1097" href="CoproductIdentities.html#1097" class="Bound">B</a> <a id="1099" class="Symbol">:</a> <a id="1101" href="CoproductIdentities.html#1082" class="Bound">A</a> <a id="1103" class="Symbol">→</a> <a id="1105" href="Intro.html#1943" class="Function">Type</a> <a id="1110" href="Intro.html#2500" class="Generalizable">ℓⱼ</a><a id="1112" class="Symbol">}</a> <a id="1114" class="Symbol">{</a><a id="1115" href="CoproductIdentities.html#1115" class="Bound">A&#39;</a> <a id="1118" class="Symbol">:</a> <a id="1120" href="Intro.html#1943" class="Function">Type</a> <a id="1125" href="Intro.html#2503" class="Generalizable">ℓₖ</a><a id="1127" class="Symbol">}</a> <a id="1129" class="Symbol">{</a><a id="1130" href="CoproductIdentities.html#1130" class="Bound">B&#39;</a> <a id="1133" class="Symbol">:</a> <a id="1135" href="CoproductIdentities.html#1115" class="Bound">A&#39;</a> <a id="1138" class="Symbol">→</a> <a id="1140" href="Intro.html#1943" class="Function">Type</a> <a id="1145" href="Intro.html#2495" class="Generalizable">ℓ</a><a id="1146" class="Symbol">}</a>
...
<a id="∑-lift"></a><a id="1828" href="CoproductIdentities.html#1828" class="Function">∑-lift</a>
  <a id="1837" class="Symbol">:</a> <a id="1839" class="Symbol">{</a><a id="1840" href="CoproductIdentities.html#1840" class="Bound">A</a><a id="1841" class="Bound"> </a><a id="1842" class="Symbol">:</a><a id="1843" class="Bound"> </a><a id="1844" href="Intro.html#1943" class="Function">Type</a> <a id="1849" href="Intro.html#2497" class="Generalizable">ℓᵢ</a><a id="1851" class="Symbol">}</a><a id="1852" class="Function"> </a><a id="1853" class="Symbol">{</a><a id="1854" href="CoproductIdentities.html#1854" class="Bound">B</a><a id="1855" class="Bound"> </a><a id="1856" class="Symbol">:</a><a id="1857" class="Function"> </a><a id="1858" href="CoproductIdentities.html#1840" class="Bound">A</a><a id="1859" class="Bound"> </a><a id="1860" class="Symbol">→</a><a id="1861" class="Function"> </a><a id="1862" href="Intro.html#1943" class="Function">Type</a> <a id="1867" href="Intro.html#2500" class="Generalizable">ℓⱼ</a><a id="1869" class="Symbol">}</a> <a id="1871" class="Symbol">{</a><a id="1872" href="CoproductIdentities.html#1872" class="Bound">C</a> <a id="1874" class="Symbol">:</a> <a id="1876" href="CoproductIdentities.html#1840" class="Bound">A</a> <a id="1878" class="Symbol">→</a> <a id="1880" href="Intro.html#1943" class="Function">Type</a> <a id="1885" href="Intro.html#2503" class="Generalizable">ℓₖ</a><a id="1887" class="Symbol">}</a>
