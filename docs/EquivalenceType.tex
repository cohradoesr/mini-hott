...
<a id="_≃_"></a><a id="1467" href="EquivalenceType.html#1467" class="Function Operator">_≃_</a>
  <a id="1473" class="Symbol">:</a> <a id="1475" class="Symbol">(</a><a id="1476" href="EquivalenceType.html#1476" class="Bound">A</a> <a id="1478" class="Symbol">:</a> <a id="1480" href="Intro.html#2811" class="Function">Type</a> <a id="1485" href="Intro.html#3480" class="Generalizable">ℓᵢ</a><a id="1487" class="Symbol">)</a> <a id="1489" class="Symbol">(</a><a id="1490" href="EquivalenceType.html#1490" class="Bound">B</a> <a id="1492" class="Symbol">:</a> <a id="1494" href="Intro.html#2811" class="Function">Type</a> <a id="1499" href="Intro.html#3483" class="Generalizable">ℓⱼ</a><a id="1501" class="Symbol">)</a>
  <a id="1505" class="Symbol">→</a> <a id="1507" href="Intro.html#2811" class="Function">Type</a> <a id="1512" class="Symbol">(</a><a id="1513" href="Intro.html#3480" class="Generalizable">ℓᵢ</a> <a id="1516" href="Agda.Primitive.html#657" class="Primitive Operator">⊔</a> <a id="1518" href="Intro.html#3483" class="Generalizable">ℓⱼ</a><a id="1520" class="Symbol">)</a>

<a id="1523" href="EquivalenceType.html#1523" class="Bound">A</a> <a id="1525" href="EquivalenceType.html#1467" class="Function Operator">≃</a> <a id="1527" href="EquivalenceType.html#1527" class="Bound">B</a> <a id="1529" class="Symbol">=</a> <a id="1531" href="BasicTypes.html#1690" class="Function">Σ</a> <a id="1533" class="Symbol">(</a><a id="1534" href="EquivalenceType.html#1523" class="Bound">A</a> <a id="1536" class="Symbol">→</a> <a id="1538" href="EquivalenceType.html#1527" class="Bound">B</a><a id="1539" class="Symbol">)</a> <a id="1541" href="EquivalenceType.html#1231" class="Function">isEquiv</a>
</pre>

<pre class="Agda">
<a id="1574" class="Keyword">module</a> <a id="EquivalenceMaps"></a><a id="1581" href="EquivalenceType.html#1581" class="Module">EquivalenceMaps</a> <a id="1597" class="Symbol">{</a><a id="1598" href="EquivalenceType.html#1598" class="Bound">A</a> <a id="1600" class="Symbol">:</a> <a id="1602" href="Intro.html#2811" class="Function">Type</a> <a id="1607" href="Intro.html#3480" class="Generalizable">ℓᵢ</a><a id="1609" class="Symbol">}</a> <a id="1611" class="Symbol">{</a><a id="1612" href="EquivalenceType.html#1612" class="Bound">B</a> <a id="1614" class="Symbol">:</a> <a id="1616" href="Intro.html#2811" class="Function">Type</a> <a id="1621" href="Intro.html#3483" class="Generalizable">ℓⱼ</a><a id="1623" class="Symbol">}</a> <a id="1625" class="Keyword">where</a>
</pre>
...
<pre class="Agda">
  ...
  <a id="1730" href="EquivalenceType.html#1683" class="Function">lemap</a> <a id="1736" class="Symbol">=</a> <a id="1738" href="BasicTypes.html#1598" class="Field">π₁</a>
</pre>
...
<pre class="Agda">
  ...
  <a id="1982" href="EquivalenceType.html#1933" class="Function">remap</a> <a id="1988" class="Symbol">(</a><a id="1989" href="EquivalenceType.html#1989" class="Bound">f</a> <a id="1991" href="BasicTypes.html#1582" class="InductiveConstructor Operator">,</a> <a id="1993" href="EquivalenceType.html#1993" class="Bound">contrf</a><a id="1999" class="Symbol">)</a> <a id="2001" href="EquivalenceType.html#2001" class="Bound">b</a> <a id="2003" class="Symbol">=</a> <a id="2005" href="BasicTypes.html#1598" class="Field">π₁</a> <a id="2008" class="Symbol">(</a><a id="2009" href="BasicTypes.html#1598" class="Field">π₁</a> <a id="2012" class="Symbol">(</a><a id="2013" href="EquivalenceType.html#1993" class="Bound">contrf</a> <a id="2020" href="EquivalenceType.html#2001" class="Bound">b</a><a id="2021" class="Symbol">))</a>
</pre>
...
<pre class="Agda">
  ...
  <a id="EquivalenceMaps.rapply"></a><a id="2105" href="EquivalenceType.html#2105" class="Function">rapply</a>  <a id="2113" class="Symbol">=</a> <a id="2115" href="EquivalenceType.html#1933" class="Function">remap</a>

  <a id="2124" class="Keyword">infixl</a> <a id="2131" class="Number">70</a> <a id="2134" href="EquivalenceType.html#2087" class="Function Operator">_∙←</a>
</pre>
...
{: .foldable until="4" }
<pre class="Agda">
  <a id="EquivalenceMaps.lrmap-inverse"></a><a id="2245" href="EquivalenceType.html#2245" class="Function">lrmap-inverse</a>
    <a id="2263" class="Symbol">:</a> <a id="2265" class="Symbol">(</a><a id="2266" href="EquivalenceType.html#2266" class="Bound">e</a> <a id="2268" class="Symbol">:</a> <a id="2270" href="EquivalenceType.html#1598" class="Bound">A</a> <a id="2272" href="EquivalenceType.html#1467" class="Function Operator">≃</a> <a id="2274" href="EquivalenceType.html#1612" class="Bound">B</a><a id="2275" class="Symbol">)</a> <a id="2277" class="Symbol">→</a> <a id="2279" class="Symbol">{</a><a id="2280" href="EquivalenceType.html#2280" class="Bound">b</a> <a id="2282" class="Symbol">:</a> <a id="2284" href="EquivalenceType.html#1612" class="Bound">B</a><a id="2285" class="Symbol">}</a>
    <a id="2291" class="Comment">-----------------------</a>
    <a id="2319" class="Symbol">→</a> <a id="2321" class="Symbol">(</a><a id="2322" href="EquivalenceType.html#2266" class="Bound">e</a> <a id="2324" href="EquivalenceType.html#1830" class="Function Operator">∙→</a><a id="2326" class="Symbol">)</a> <a id="2328" class="Symbol">((</a><a id="2330" href="EquivalenceType.html#2266" class="Bound">e</a> <a id="2332" href="EquivalenceType.html#2087" class="Function Operator">∙←</a><a id="2334" class="Symbol">)</a> <a id="2336" href="EquivalenceType.html#2280" class="Bound">b</a><a id="2337" class="Symbol">)</a> <a id="2339" href="BasicTypes.html#6056" class="Datatype Operator">==</a> <a id="2342" href="EquivalenceType.html#2280" class="Bound">b</a>

  <a id="2347" href="EquivalenceType.html#2245" class="Function">lrmap-inverse</a> <a id="2361" class="Symbol">(</a><a id="2362" href="EquivalenceType.html#2362" class="Bound">f</a> <a id="2364" href="BasicTypes.html#1582" class="InductiveConstructor Operator">,</a> <a id="2366" href="EquivalenceType.html#2366" class="Bound">eqf</a><a id="2369" class="Symbol">)</a> <a id="2371" class="Symbol">{</a><a id="2372" href="EquivalenceType.html#2372" class="Bound">b</a><a id="2373" class="Symbol">}</a> <a id="2375" class="Symbol">=</a> <a id="2377" href="FibreType.html#676" class="Function">fib-eq</a> <a id="2384" class="Symbol">(</a><a id="2385" href="BasicTypes.html#1598" class="Field">π₁</a> <a id="2388" class="Symbol">(</a><a id="2389" href="EquivalenceType.html#2366" class="Bound">eqf</a> <a id="2393" href="EquivalenceType.html#2372" class="Bound">b</a><a id="2394" class="Symbol">))</a>
</pre>

<pre class="Agda">
  <a id="EquivalenceMaps.∙→∘∙←"></a><a id="2424" href="EquivalenceType.html#2424" class="Function">∙→∘∙←</a> <a id="2430" class="Symbol">=</a> <a id="2432" href="EquivalenceType.html#2245" class="Function">lrmap-inverse</a>
</pre>

{: .foldable until="4" }
<pre class="Agda">
  <a id="EquivalenceMaps.rlmap-inverse"></a><a id="2498" href="EquivalenceType.html#2498" class="Function">rlmap-inverse</a>
    <a id="2516" class="Symbol">:</a> <a id="2518" class="Symbol">(</a><a id="2519" href="EquivalenceType.html#2519" class="Bound">e</a> <a id="2521" class="Symbol">:</a> <a id="2523" href="EquivalenceType.html#1598" class="Bound">A</a> <a id="2525" href="EquivalenceType.html#1467" class="Function Operator">≃</a> <a id="2527" href="EquivalenceType.html#1612" class="Bound">B</a><a id="2528" class="Symbol">)</a> <a id="2530" class="Symbol">→</a> <a id="2532" class="Symbol">{</a><a id="2533" href="EquivalenceType.html#2533" class="Bound">a</a> <a id="2535" class="Symbol">:</a> <a id="2537" href="EquivalenceType.html#1598" class="Bound">A</a><a id="2538" class="Symbol">}</a>
    <a id="2544" class="Comment">------------------------</a>
    <a id="2573" class="Symbol">→</a> <a id="2575" class="Symbol">(</a><a id="2576" href="EquivalenceType.html#2519" class="Bound">e</a> <a id="2578" href="EquivalenceType.html#2087" class="Function Operator">∙←</a><a id="2580" class="Symbol">)</a> <a id="2582" class="Symbol">((</a><a id="2584" href="EquivalenceType.html#2519" class="Bound">e</a> <a id="2586" href="EquivalenceType.html#1830" class="Function Operator">∙→</a><a id="2588" class="Symbol">)</a> <a id="2590" href="EquivalenceType.html#2533" class="Bound">a</a><a id="2591" class="Symbol">)</a> <a id="2593" href="BasicTypes.html#6056" class="Datatype Operator">==</a> <a id="2596" href="EquivalenceType.html#2533" class="Bound">a</a>

  <a id="2601" href="EquivalenceType.html#2498" class="Function">rlmap-inverse</a> <a id="2615" class="Symbol">(</a><a id="2616" href="EquivalenceType.html#2616" class="Bound">f</a> <a id="2618" href="BasicTypes.html#1582" class="InductiveConstructor Operator">,</a> <a id="2620" href="EquivalenceType.html#2620" class="Bound">eqf</a><a id="2623" class="Symbol">)</a> <a id="2625" class="Symbol">{</a><a id="2626" href="EquivalenceType.html#2626" class="Bound">a</a><a id="2627" class="Symbol">}</a> <a id="2629" class="Symbol">=</a> <a id="2631" href="AlgebraOnPaths.html#390" class="Function">ap</a> <a id="2634" href="BasicTypes.html#1598" class="Field">π₁</a> <a id="2637" class="Symbol">((</a><a id="2639" href="BasicTypes.html#1609" class="Field">π₂</a> <a id="2642" class="Symbol">(</a><a id="2643" href="EquivalenceType.html#2620" class="Bound">eqf</a> <a id="2647" class="Symbol">(</a><a id="2648" href="EquivalenceType.html#2616" class="Bound">f</a> <a id="2650" href="EquivalenceType.html#2626" class="Bound">a</a><a id="2651" class="Symbol">)))</a> <a id="2655" href="FibreType.html#892" class="Function">fib-image</a><a id="2664" class="Symbol">)</a>
</pre>
<pre class="Agda">
  <a id="EquivalenceMaps.∙←∘∙→"></a><a id="2692" href="EquivalenceType.html#2692" class="Function">∙←∘∙→</a> <a id="2698" class="Symbol">=</a> <a id="2700" href="EquivalenceType.html#2498" class="Function">rlmap-inverse</a>
</pre>

{: .foldable until="4" }
<pre class="Agda">
  <a id="EquivalenceMaps.lrmap-inverse-h"></a><a id="2766" href="EquivalenceType.html#2766" class="Function">lrmap-inverse-h</a>
    <a id="2786" class="Symbol">:</a> <a id="2788" class="Symbol">(</a><a id="2789" href="EquivalenceType.html#2789" class="Bound">e</a> <a id="2791" class="Symbol">:</a> <a id="2793" href="EquivalenceType.html#1598" class="Bound">A</a> <a id="2795" href="EquivalenceType.html#1467" class="Function Operator">≃</a> <a id="2797" href="EquivalenceType.html#1612" class="Bound">B</a><a id="2798" class="Symbol">)</a>
    <a id="2804" class="Comment">------------------------</a>
    <a id="2833" class="Symbol">→</a> <a id="2835" class="Symbol">((</a><a id="2837" href="EquivalenceType.html#2789" class="Bound">e</a> <a id="2839" href="EquivalenceType.html#1830" class="Function Operator">∙→</a><a id="2841" class="Symbol">)</a> <a id="2843" href="BasicFunctions.html#1044" class="Function Operator">∘</a> <a id="2845" class="Symbol">(</a><a id="2846" href="EquivalenceType.html#2789" class="Bound">e</a> <a id="2848" href="EquivalenceType.html#2087" class="Function Operator">∙←</a><a id="2850" class="Symbol">))</a> <a id="2853" href="HomotopyType.html#989" class="Function Operator">∼</a> <a id="2855" href="BasicFunctions.html#376" class="Function">id</a>

  <a id="2861" href="EquivalenceType.html#2766" class="Function">lrmap-inverse-h</a> <a id="2877" href="EquivalenceType.html#2877" class="Bound">e</a> <a id="2879" class="Symbol">=</a> <a id="2881" class="Symbol">λ</a> <a id="2883" href="EquivalenceType.html#2883" class="Bound">x</a> <a id="2885" class="Symbol">→</a> <a id="2887" href="EquivalenceType.html#2245" class="Function">lrmap-inverse</a> <a id="2901" href="EquivalenceType.html#2877" class="Bound">e</a> <a id="2903" class="Symbol">{</a><a id="2904" href="EquivalenceType.html#2883" class="Bound">x</a><a id="2905" class="Symbol">}</a>
</pre>

<pre class="Agda">
  <a id="EquivalenceMaps.∙→∘∙←-h"></a><a id="2934" href="EquivalenceType.html#2934" class="Function">∙→∘∙←-h</a> <a id="2942" class="Symbol">=</a> <a id="2944" href="EquivalenceType.html#2766" class="Function">lrmap-inverse-h</a>
</pre>

{: .foldable until="4" }
<pre class="Agda">
  <a id="EquivalenceMaps.rlmap-inverse-h"></a><a id="3012" href="EquivalenceType.html#3012" class="Function">rlmap-inverse-h</a>
    <a id="3032" class="Symbol">:</a> <a id="3034" class="Symbol">(</a><a id="3035" href="EquivalenceType.html#3035" class="Bound">e</a> <a id="3037" class="Symbol">:</a> <a id="3039" href="EquivalenceType.html#1598" class="Bound">A</a> <a id="3041" href="EquivalenceType.html#1467" class="Function Operator">≃</a> <a id="3043" href="EquivalenceType.html#1612" class="Bound">B</a><a id="3044" class="Symbol">)</a>
    <a id="3050" class="Comment">------------------------</a>
    <a id="3079" class="Symbol">→</a> <a id="3081" class="Symbol">((</a><a id="3083" href="EquivalenceType.html#3035" class="Bound">e</a> <a id="3085" href="EquivalenceType.html#2087" class="Function Operator">∙←</a><a id="3087" class="Symbol">)</a> <a id="3089" href="BasicFunctions.html#1044" class="Function Operator">∘</a> <a id="3091" class="Symbol">(</a><a id="3092" href="EquivalenceType.html#3035" class="Bound">e</a> <a id="3094" href="EquivalenceType.html#1830" class="Function Operator">∙→</a><a id="3096" class="Symbol">))</a> <a id="3099" href="HomotopyType.html#989" class="Function Operator">∼</a> <a id="3101" href="BasicFunctions.html#376" class="Function">id</a>

  <a id="3107" href="EquivalenceType.html#3012" class="Function">rlmap-inverse-h</a> <a id="3123" href="EquivalenceType.html#3123" class="Bound">e</a> <a id="3125" class="Symbol">=</a> <a id="3127" class="Symbol">λ</a> <a id="3129" href="EquivalenceType.html#3129" class="Bound">x</a> <a id="3131" class="Symbol">→</a> <a id="3133" href="EquivalenceType.html#2498" class="Function">rlmap-inverse</a> <a id="3147" href="EquivalenceType.html#3123" class="Bound">e</a> <a id="3149" class="Symbol">{</a><a id="3150" href="EquivalenceType.html#3129" class="Bound">x</a><a id="3151" class="Symbol">}</a>
</pre>

<pre class="Agda">
  <a id="EquivalenceMaps.∙←∘∙→-h"></a><a id="3180" href="EquivalenceType.html#3180" class="Function">∙←∘∙→-h</a> <a id="3188" class="Symbol">=</a> <a id="3190" href="EquivalenceType.html#3012" class="Function">rlmap-inverse-h</a>
</pre>

<pre class="Agda">
<a id="3231" class="Keyword">open</a> <a id="3236" href="EquivalenceType.html#1581" class="Module">EquivalenceMaps</a> <a id="3252" class="Keyword">public</a>
</pre>
